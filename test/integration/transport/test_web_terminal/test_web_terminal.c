...
//
// Unit tests for the WebSocket web-serial terminal (PROTOCORE_ENABLE_WEB_TERMINAL):
...
// Set for the one test that must observe the module before protocore_web_terminal_begin()
