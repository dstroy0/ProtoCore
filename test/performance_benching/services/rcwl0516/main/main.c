...
void dbench_run(void)
{
    for (;;)
    {
        ...
        Rcwl0516V.presence_init_args.debounce_ms = 50;
        Rcwl0516V.presence_init_args.hold_ms = 2000;
        ...
        DBENCH_OP("protocore_presence_core_update", 200000, {
            Rcwl0516V.presence_update_args.c = &c;
            Rcwl0516V.presence_update_args.pin_high = (t & 64) != 0;
            Rcwl0516V.presence_update_args.now = t;
            Rcwl0516.presence_update(protocore_rcwl0516_span());
            sink += Rcwl0516V.ok;
            t += 3;
        });
        DBENCH_OP("Rcwl0516.presence_get", 200000, {
            Rcwl0516V.presence_get_args.c = &c;
