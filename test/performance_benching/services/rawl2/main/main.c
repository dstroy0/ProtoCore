...
void dbench_run(void)
{
    ...
    Rawl2V.build_args.ethertype = 0x88B8;
    Rawl2V.build_args.payload = payload;
    Rawl2V.build_args.payload_len = sizeof(payload);
    Rawl2V.build_args.out = frame;
    Rawl2V.build_args.cap = sizeof(frame);
    Rawl2.build(rawl2_work);
    size_t flen = Rawl2V.n;
    Rawl2V.build_vlan_args.dst = DST;
    Rawl2V.build_vlan_args.src = SRC;
    Rawl2V.build_vlan_args.pcp = 5;
    Rawl2V.build_vlan_args.dei = false;
    Rawl2V.build_vlan_args.vid = 100;
    Rawl2V.build_vlan_args.ethertype = 0x0800;
    Rawl2V.build_vlan_args.payload = payload;
    Rawl2V.build_vlan_args.payload_len = sizeof(payload);
    Rawl2V.build_vlan_args.out = vframe;
    Rawl2V.build_vlan_args.cap = sizeof(vframe);
    ...
    for (;;)
    {
        ...
        DBENCH_OP("Rawl2.build (64B payload)", 200000, sink += (Rawl2.build(rawl2_work), Rawl2V.n));
        Rawl2V.build_vlan_args.dst = DST;
        Rawl2V.build_vlan_args.src = SRC;
        Rawl2V.build_vlan_args.pcp = 5;
        Rawl2V.build_vlan_args.dei = false;
        ...
        DBENCH_OP("Rawl2.build_vlan (64B)", 200000, sink += (Rawl2.build_vlan(rawl2_work), Rawl2V.n));
        EthFrame ef;
        Rawl2V.parse_args.frame = frame;
        Rawl2V.parse_args.len = flen;
        Rawl2V.parse_args.out = &ef;
        DBENCH_OP("Rawl2.parse", 200000, sink += (Rawl2.parse(rawl2_work), Rawl2V.ok));
        Rawl2V.parse_args.frame = vframe;
        Rawl2V.parse_args.len = flen + 4;
        Rawl2V.parse_args.out = &ef;
        DBENCH_OP("Rawl2.parse (vlan)", 200000, sink += (Rawl2.parse(rawl2_work), Rawl2V.ok));
        Rawl2V.fcs_args.bytes = frame;
        Rawl2V.fcs_args.len = flen;
        DBENCH_BULK("Rawl2.fcs (CRC-32)", 50000, flen, sink += (Rawl2.fcs(rawl2_work), Rawl2V.u32));
        (void)sink;
        DBENCH_DONE();
    }
}
