 ...
 * vendor is chosen by the PROTOCORE_VENDOR_* selector (protocore_platform.h); this whole TU
 ...
 * test/core_setup/physical/<vendor>/ TU guarded by that vendor's macro, no change here.
 *
