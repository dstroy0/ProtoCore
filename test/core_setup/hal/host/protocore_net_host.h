...
//
// src/protocore_platform.h aliases that surface onto the vendor's calls on
...
// The vendor seams test/core_setup/hal/host/host_platform.c answers for. Declared here because this is
