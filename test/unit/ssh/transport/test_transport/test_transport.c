...
static const uint8_t K7_2_C_64[] = {
    0x5E, 0x9A, 0x63, 0x26, 0x40, 0xAE, 0xDE, 0xC3, 0xEA, 0x70, 0xFE, 0x33, 0xCA, 0xFF, 0xBC, 0xB8,
    0xD0, 0x91, 0xFE, 0x11, 0x9C, 0x08, 0x49, 0x4E, 0xC1, 0xD0, 0xDF, 0xFB, 0xCE, 0x9C, 0xE4, 0xBA,
    0x70, 0xA0, 0x22, 0x24, 0x4C, 0xAA, 0xA6, 0x87, 0x27, 0xB6, 0x37, 0x87, 0x06, 0xC2, 0x63, 0x4E,
    0x21, 0x1F, 0xFC, 0x88, 0x7E, 0xD2, 0x64, 0xA5, 0x86, 0xAC, 0xAB, 0x7D, 0xD7, 0x94, 0xBE, 0x26};
...
static void test_sec11_1_field_order(void)
{
    ...
    TEST_ASSERT_EQUAL_INT(
        0, ssh_pkt_build_disconnect(SSH_DISCONNECT_SERVICE_NOT_AVAILABLE, desc, sizeof(desc) - 1, out, &n, sizeof(out)));
