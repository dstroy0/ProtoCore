...
{
    Rcwl0516V.presence_update_args.c = &g_core;
    Rcwl0516V.presence_update_args.pin_high = level;
    Rcwl0516V.presence_update_args.now = now;
...
{
    Rcwl0516V.presence_init_args.c = &g_core;
    Rcwl0516V.presence_init_args.debounce_ms = DEBOUNCE;
    Rcwl0516V.presence_init_args.hold_ms = HOLD;
    Rcwl0516V.presence_init_args.now = 1000;
    Rcwl0516.presence_init(protocore_rcwl0516_span());
    Rcwl0516V.presence_get_args.c = &g_core;
    Rcwl0516.presence_get(protocore_rcwl0516_span());
    TEST_ASSERT_FALSE(Rcwl0516V.ok);
    Rcwl0516V.presence_take_event_args.c = &g_core;
...
void test_a_level_is_believed_only_after_the_debounce(void)
{
    ...
    Rcwl0516V.presence_init_args.debounce_ms = DEBOUNCE;
    Rcwl0516V.presence_init_args.hold_ms = HOLD;
    Rcwl0516V.presence_init_args.now = 0;
    Rcwl0516.presence_init(protocore_rcwl0516_span());
...
void test_presence_clears_exactly_one_hold_after_the_last_high(void)
{
    ...
    Rcwl0516V.presence_take_event_args.c = &g_core;
    Rcwl0516.presence_take_event(protocore_rcwl0516_span());
    TEST_ASSERT_FALSE(Rcwl0516V.ok); // no edge yet
...
{
    Rcwl0516V.presence_init_args.c = &g_core;
    Rcwl0516V.presence_init_args.debounce_ms = 0;
    Rcwl0516V.presence_init_args.hold_ms = 0;
    Rcwl0516V.presence_init_args.now = 0;
    Rcwl0516.presence_init(protocore_rcwl0516_span());
...
void test_timing_survives_the_millis_rollover(void)
{
    ...
    Rcwl0516V.presence_init_args.debounce_ms = DEBOUNCE;
    Rcwl0516V.presence_init_args.hold_ms = HOLD;
    Rcwl0516V.presence_init_args.now = t0;
    Rcwl0516.presence_init(protocore_rcwl0516_span());
...
{
    Rcwl0516V.presence_init_args.c = &g_core;
    Rcwl0516V.presence_init_args.debounce_ms = 1;
    Rcwl0516V.presence_init_args.hold_ms = 1;
    Rcwl0516V.presence_init_args.now = 0;
    Rcwl0516.presence_init(protocore_rcwl0516_span()); // deliberately wrong, then overwritten
    Rcwl0516V.core_init_args.c = &g_core;
    Rcwl0516V.core_init_args.now = 12345;
    ...
    Rcwl0516V.presence_get_args.c = &g_core;
    Rcwl0516.presence_get(protocore_rcwl0516_span());
    TEST_ASSERT_FALSE(Rcwl0516V.ok); // still fail-safe
}
...
{
    Rcwl0516V.presence_init_args.c = NULL;
    Rcwl0516V.presence_init_args.debounce_ms = DEBOUNCE;
    Rcwl0516V.presence_init_args.hold_ms = HOLD;
    Rcwl0516V.presence_init_args.now = 0;
    Rcwl0516.presence_init(protocore_rcwl0516_span()); // must not fault
    Rcwl0516V.presence_update_args.c = NULL;
    Rcwl0516V.presence_update_args.pin_high = PROTO_TRUE;
    Rcwl0516V.presence_update_args.now = 0;
    Rcwl0516.presence_update(protocore_rcwl0516_span());
    TEST_ASSERT_FALSE(Rcwl0516V.ok);
    Rcwl0516V.presence_get_args.c = NULL;
    Rcwl0516.presence_get(protocore_rcwl0516_span());
    TEST_ASSERT_FALSE(Rcwl0516V.ok);
    Rcwl0516V.presence_take_event_args.c = NULL;
    Rcwl0516.presence_take_event(protocore_rcwl0516_span());
    TEST_ASSERT_FALSE(Rcwl0516V.ok);
}
