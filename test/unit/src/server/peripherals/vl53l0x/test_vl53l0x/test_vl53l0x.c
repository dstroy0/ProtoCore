...
{
    Vl53l0xV.range_mm_args.hi = 0x00;
    Vl53l0xV.range_mm_args.lo = 0x00;
    Vl53l0x.range_mm(protocore_vl53l0x_span());
    TEST_ASSERT_EQUAL_UINT16(0u, Vl53l0xV.mm);
    // 0x04D2 = 4*256 + 13*16 + 2 = 1024 + 208 + 2 = 1234 mm
    Vl53l0xV.range_mm_args.hi = 0x04;
    Vl53l0xV.range_mm_args.lo = 0xD2;
    Vl53l0x.range_mm(protocore_vl53l0x_span());
    TEST_ASSERT_EQUAL_UINT16(1234u, Vl53l0xV.mm);
    // the two octets are not interchangeable: swapping them names a different distance
    Vl53l0xV.range_mm_args.hi = 0xD2;
    Vl53l0xV.range_mm_args.lo = 0x04;
    Vl53l0x.range_mm(protocore_vl53l0x_span());
    TEST_ASSERT_EQUAL_UINT16(0xD204u, Vl53l0xV.mm);
    // 8190 mm is the out-of-range value the part reports when nothing is in front of it
    Vl53l0xV.range_mm_args.hi = 0x1F;
    Vl53l0xV.range_mm_args.lo = 0xFE;
    Vl53l0x.range_mm(protocore_vl53l0x_span());
    TEST_ASSERT_EQUAL_UINT16(8190u, Vl53l0xV.mm);
    Vl53l0xV.range_mm_args.hi = 0xFF;
    Vl53l0xV.range_mm_args.lo = 0xFF;
    Vl53l0x.range_mm(protocore_vl53l0x_span());
    TEST_ASSERT_EQUAL_UINT16(65535u, Vl53l0xV.mm);
}
...
void test_range_octets_never_overlap(void)
{
    for (unsigned hi = 0; hi < 256u; hi += 17u)
    {
        ...
        {
            Vl53l0xV.range_mm_args.hi = (uint8_t)hi;
            Vl53l0xV.range_mm_args.lo = (uint8_t)lo;
            Vl53l0x.range_mm(protocore_vl53l0x_span());
            uint16_t mm = Vl53l0xV.mm;
...
{
    Vl53l0xV.data_ready_args.interrupt_status = 0x00;
    Vl53l0x.data_ready(protocore_vl53l0x_span());
    TEST_ASSERT_FALSE(Vl53l0xV.ok);
    Vl53l0xV.data_ready_args.interrupt_status = 0x01;
    Vl53l0x.data_ready(protocore_vl53l0x_span());
    TEST_ASSERT_TRUE(Vl53l0xV.ok);
    Vl53l0xV.data_ready_args.interrupt_status = 0x02;
    Vl53l0x.data_ready(protocore_vl53l0x_span());
    TEST_ASSERT_TRUE(Vl53l0xV.ok);
    Vl53l0xV.data_ready_args.interrupt_status = 0x04;
    Vl53l0x.data_ready(protocore_vl53l0x_span());
    TEST_ASSERT_TRUE(Vl53l0xV.ok);
    Vl53l0xV.data_ready_args.interrupt_status = 0x07;
    Vl53l0x.data_ready(protocore_vl53l0x_span());
    TEST_ASSERT_TRUE(Vl53l0xV.ok);
    // bits 3 and up on their own are not a data-ready report
    Vl53l0xV.data_ready_args.interrupt_status = 0x08;
    Vl53l0x.data_ready(protocore_vl53l0x_span());
    TEST_ASSERT_FALSE(Vl53l0xV.ok);
    Vl53l0xV.data_ready_args.interrupt_status = 0x10;
    Vl53l0x.data_ready(protocore_vl53l0x_span());
    TEST_ASSERT_FALSE(Vl53l0xV.ok);
    Vl53l0xV.data_ready_args.interrupt_status = 0xF8;
    Vl53l0x.data_ready(protocore_vl53l0x_span());
    TEST_ASSERT_FALSE(Vl53l0xV.ok);
    // a set low bit is still a report when the bits above it are set too
    Vl53l0xV.data_ready_args.interrupt_status = 0xFF;
    Vl53l0x.data_ready(protocore_vl53l0x_span());
    TEST_ASSERT_TRUE(Vl53l0xV.ok);
}
...
void test_range_status_is_bits_6_to_3(void)
{
    ...
    for (unsigned code = 0; code < 16u; code++)
    {
        ...
        Vl53l0xV.range_status_args.range_status_reg = reg;
        Vl53l0x.range_status(protocore_vl53l0x_span());
        TEST_ASSERT_EQUAL_UINT8((uint8_t)code, Vl53l0xV.status);
        if (code == VL53L0X_RANGE_VALID)
        {
            Vl53l0xV.range_valid_args.range_status_reg = reg;
...
{
    Vl53l0xV.range_status_args.range_status_reg = 11u << 3;
    Vl53l0x.range_status(protocore_vl53l0x_span());
    TEST_ASSERT_EQUAL_UINT8(11u, Vl53l0xV.status); // good ranging
    Vl53l0xV.range_valid_args.range_status_reg = 11u << 3;
    Vl53l0x.range_valid(protocore_vl53l0x_span());
    TEST_ASSERT_TRUE(Vl53l0xV.ok);
    Vl53l0xV.range_status_args.range_status_reg = 1u << 3;
    Vl53l0x.range_status(protocore_vl53l0x_span());
    TEST_ASSERT_EQUAL_UINT8(1u, Vl53l0xV.status); // VCSEL continuity fail
    Vl53l0xV.range_valid_args.range_status_reg = 1u << 3;
    Vl53l0x.range_valid(protocore_vl53l0x_span());
    TEST_ASSERT_FALSE(Vl53l0xV.ok);
    Vl53l0xV.range_status_args.range_status_reg = 4u << 3;
    Vl53l0x.range_status(protocore_vl53l0x_span());
    TEST_ASSERT_EQUAL_UINT8(4u, Vl53l0xV.status); // signal fail
    Vl53l0xV.range_valid_args.range_status_reg = 4u << 3;
    Vl53l0x.range_valid(protocore_vl53l0x_span());
    TEST_ASSERT_FALSE(Vl53l0xV.ok);
    Vl53l0xV.range_status_args.range_status_reg = 6u << 3;
    Vl53l0x.range_status(protocore_vl53l0x_span());
    TEST_ASSERT_EQUAL_UINT8(6u, Vl53l0xV.status); // phase fail
    Vl53l0xV.range_valid_args.range_status_reg = 6u << 3;
    Vl53l0x.range_valid(protocore_vl53l0x_span());
    TEST_ASSERT_FALSE(Vl53l0xV.ok);
    Vl53l0xV.range_status_args.range_status_reg = 8u << 3;
    Vl53l0x.range_status(protocore_vl53l0x_span());
    TEST_ASSERT_EQUAL_UINT8(8u, Vl53l0xV.status); // min range fail
    Vl53l0xV.range_valid_args.range_status_reg = 8u << 3;
    Vl53l0x.range_valid(protocore_vl53l0x_span());
    TEST_ASSERT_FALSE(Vl53l0xV.ok);
    ...
    Vl53l0xV.range_valid_args.range_status_reg = 0x00;
    Vl53l0x.range_valid(protocore_vl53l0x_span());
    TEST_ASSERT_FALSE(Vl53l0xV.ok);
}
...
void test_begin_refuses_a_part_that_is_not_a_vl53l0x(void)
{
    ...
    Vl53l0xV.begin_args.addr = (uint8_t)PROTOCORE_VL53L0X_I2C_ADDR;
    Vl53l0x.begin(protocore_vl53l0x_span());
    TEST_ASSERT_FALSE(Vl53l0xV.ok);
...
void test_begin_sends_later_transfers_to_the_address_it_was_given(void)
{
    ...
    Vl53l0xV.begin_args.addr = 0x30u;
    Vl53l0x.begin(protocore_vl53l0x_span());
    TEST_ASSERT_TRUE(Vl53l0xV.ok);
    TEST_ASSERT_EQUAL_HEX16(0x30u, protocore_bus_host_log[protocore_bus_host_log_len - 1u].target);
    Vl53l0xV.begin_args.addr = 0u;
    Vl53l0x.begin(protocore_vl53l0x_span());
    TEST_ASSERT_EQUAL_HEX16(PROTOCORE_VL53L0X_I2C_ADDR, protocore_bus_host_log[protocore_bus_host_log_len - 1u].target);
}
