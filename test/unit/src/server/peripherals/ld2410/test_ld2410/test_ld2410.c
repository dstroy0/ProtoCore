...
static const uint8_t ENGINEERING[45] = {
...
void test_ld2410b_command_frames_follow_the_same_envelope(void)
{
    ...
    static const uint8_t BT_ON[14] = {0xFD, 0xFC, 0xFB, 0xFA, 0x04, 0x00, 0xA4, 0x00, 0x01, 0x00, 0x04, 0x03, 0x02,
                                      0x01};
    static const uint8_t BT_OFF[14] = {0xFD, 0xFC, 0xFB, 0xFA, 0x04, 0x00, 0xA4, 0x00, 0x00, 0x00, 0x04, 0x03, 0x02,
                                       0x01};
