...
void test_the_socketcan_layout_is_the_published_one(void)
{
    ...
    TEST_ASSERT_EQUAL_UINT(PROTOCORE_SOCKETCAN_FRAME_LEN, BusCaptureV.n);
...
void test_the_identifier_width_and_the_extended_flag(void)
{
    ...
    BusCaptureV.can_to_socketcan_args.f = &std;
    BusCaptureV.can_to_socketcan_args.out = out;
    BusCaptureV.can_to_socketcan_args.cap = sizeof(out);
    BusCapture.can_to_socketcan(protocore_bus_capture_span());
    TEST_ASSERT_EQUAL_UINT(PROTOCORE_SOCKETCAN_FRAME_LEN, BusCaptureV.n);
    ...
    BusCaptureV.can_to_socketcan_args.f = &ext;
    BusCaptureV.can_to_socketcan_args.out = out;
    BusCaptureV.can_to_socketcan_args.cap = sizeof(out);
    BusCapture.can_to_socketcan(protocore_bus_capture_span());
    TEST_ASSERT_EQUAL_UINT(PROTOCORE_SOCKETCAN_FRAME_LEN, BusCaptureV.n);
    ...
    BusCaptureV.can_to_socketcan_args.f = &wide_std;
    BusCaptureV.can_to_socketcan_args.out = out;
    BusCaptureV.can_to_socketcan_args.cap = sizeof(out);
    BusCapture.can_to_socketcan(protocore_bus_capture_span());
    TEST_ASSERT_EQUAL_UINT(PROTOCORE_SOCKETCAN_FRAME_LEN, BusCaptureV.n);
    ...
    BusCaptureV.can_to_socketcan_args.f = &wide_ext;
    BusCaptureV.can_to_socketcan_args.out = out;
    BusCaptureV.can_to_socketcan_args.cap = sizeof(out);
    BusCapture.can_to_socketcan(protocore_bus_capture_span());
    TEST_ASSERT_EQUAL_UINT(PROTOCORE_SOCKETCAN_FRAME_LEN, BusCaptureV.n);
...
void test_a_remote_frame_sets_its_flag_and_carries_no_data(void)
{
    ...
    BusCaptureV.can_to_socketcan_args.f = &rtr;
    BusCaptureV.can_to_socketcan_args.out = out;
    BusCaptureV.can_to_socketcan_args.cap = sizeof(out);
    BusCapture.can_to_socketcan(protocore_bus_capture_span());
    TEST_ASSERT_EQUAL_UINT(PROTOCORE_SOCKETCAN_FRAME_LEN, BusCaptureV.n);
    ...
    BusCaptureV.can_to_socketcan_args.f = &both;
    BusCaptureV.can_to_socketcan_args.out = out;
    BusCaptureV.can_to_socketcan_args.cap = sizeof(out);
    BusCapture.can_to_socketcan(protocore_bus_capture_span());
    TEST_ASSERT_EQUAL_UINT(PROTOCORE_SOCKETCAN_FRAME_LEN, BusCaptureV.n);
...
void test_a_short_buffer_writes_nothing(void)
{
    ...
    for (size_t cap = 0; cap < PROTOCORE_SOCKETCAN_FRAME_LEN; cap++)
    {
        ...
        BusCaptureV.can_to_socketcan_args.f = &f;
        BusCaptureV.can_to_socketcan_args.out = out;
        BusCaptureV.can_to_socketcan_args.cap = cap;
        BusCapture.can_to_socketcan(protocore_bus_capture_span());
        TEST_ASSERT_EQUAL_UINT(0u, BusCaptureV.n);
    ...
    BusCaptureV.can_to_socketcan_args.f = &f;
    BusCaptureV.can_to_socketcan_args.out = out;
    BusCaptureV.can_to_socketcan_args.cap = PROTOCORE_SOCKETCAN_FRAME_LEN;
    BusCapture.can_to_socketcan(protocore_bus_capture_span());
    TEST_ASSERT_EQUAL_UINT(PROTOCORE_SOCKETCAN_FRAME_LEN, BusCaptureV.n);
}
...
void test_null_arguments_are_refused(void)
{
    uint8_t out[PROTOCORE_SOCKETCAN_FRAME_LEN];
    CanFrame f = frame_of(0x123, PROTO_FALSE, PROTO_FALSE, 3);
    BusCaptureV.can_to_socketcan_args.f = NULL;
    BusCaptureV.can_to_socketcan_args.out = out;
    BusCaptureV.can_to_socketcan_args.cap = sizeof(out);
    BusCapture.can_to_socketcan(protocore_bus_capture_span());
    TEST_ASSERT_EQUAL_UINT(0u, BusCaptureV.n);
    BusCaptureV.can_to_socketcan_args.f = &f;
    BusCaptureV.can_to_socketcan_args.out = NULL;
    BusCaptureV.can_to_socketcan_args.cap = sizeof(out);
    BusCapture.can_to_socketcan(protocore_bus_capture_span());
    TEST_ASSERT_EQUAL_UINT(0u, BusCaptureV.n);
}
...
void test_the_framer_holds_nothing(void)
{
    ...
    BusCaptureV.can_to_socketcan_args.f = &f;
    BusCaptureV.can_to_socketcan_args.out = a;
    BusCaptureV.can_to_socketcan_args.cap = sizeof(a);
    BusCapture.can_to_socketcan(protocore_bus_capture_span());
    (void)BusCaptureV.n;
    BusCaptureV.can_to_socketcan_args.f = &g;
    BusCaptureV.can_to_socketcan_args.out = other;
    BusCaptureV.can_to_socketcan_args.cap = sizeof(other);
    BusCapture.can_to_socketcan(protocore_bus_capture_span());
    (void)BusCaptureV.n;
    BusCaptureV.can_to_socketcan_args.f = &f;
    BusCaptureV.can_to_socketcan_args.out = b;
    BusCaptureV.can_to_socketcan_args.cap = sizeof(b);
    BusCapture.can_to_socketcan(protocore_bus_capture_span());
    (void)BusCaptureV.n;
...
static void records_differ(const CanFrame *x, const CanFrame *y)
{
    uint8_t a[PROTOCORE_SOCKETCAN_FRAME_LEN];
    uint8_t b[PROTOCORE_SOCKETCAN_FRAME_LEN];
    BusCaptureV.can_to_socketcan_args.f = x;
    BusCaptureV.can_to_socketcan_args.out = a;
    BusCaptureV.can_to_socketcan_args.cap = sizeof(a);
    BusCapture.can_to_socketcan(protocore_bus_capture_span());
    TEST_ASSERT_EQUAL_UINT(PROTOCORE_SOCKETCAN_FRAME_LEN, BusCaptureV.n);
    BusCaptureV.can_to_socketcan_args.f = y;
    BusCaptureV.can_to_socketcan_args.out = b;
    BusCaptureV.can_to_socketcan_args.cap = sizeof(b);
    BusCapture.can_to_socketcan(protocore_bus_capture_span());
    TEST_ASSERT_EQUAL_UINT(PROTOCORE_SOCKETCAN_FRAME_LEN, BusCaptureV.n);
...
{
    BusCaptureV.begin_args.tx_pin = 4;
    BusCaptureV.begin_args.rx_pin = 5;
    BusCaptureV.begin_args.bitrate = 500000u;
    BusCaptureV.begin_args.sink = NULL;
    BusCapture.begin(protocore_bus_capture_span());
    TEST_ASSERT_FALSE(BusCaptureV.ok);
