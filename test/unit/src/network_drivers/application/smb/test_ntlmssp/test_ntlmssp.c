...
void test_msnlmp_authenticate_message(void)
{
    ...
    uint8_t buf[512];
    size_t n =
        protocore_ntlmssp_build_authenticate(buf, sizeof(buf), LM_RESP, sizeof(LM_RESP), NT_RESP, sizeof(NT_RESP),
...
void test_authenticate_fails_closed(void)
{
    ...
    TEST_ASSERT_EQUAL_size_t(
        0, protocore_ntlmssp_build_authenticate(buf, 87, NULL, 0, NULL, 0, NULL, NULL, NULL, 0, PROTO_TRUE));
    TEST_ASSERT_EQUAL_size_t(
        88, protocore_ntlmssp_build_authenticate(buf, 88, NULL, 0, NULL, 0, NULL, NULL, NULL, 0, PROTO_TRUE));
}
...
void test_absent_identity_fields(void)
{
    uint8_t buf[256];
    size_t n =
        protocore_ntlmssp_build_authenticate(buf, sizeof(buf), NULL, 0, NULL, 0, NULL, NULL, NULL, 0, PROTO_FALSE);
