...
void test_rfc7541_c1_integer_examples(void)
{
    ...
    HpackPrimV.encode_int_args.out = b;
    HpackPrimV.encode_int_args.cap = sizeof(b);
    HpackPrimV.encode_int_args.prefix_bits = 5;
    HpackPrimV.encode_int_args.flags = 0;
    HpackPrimV.encode_int_args.value = 10;
    HpackPrim.encode_int(hpack_prim_work);
    TEST_ASSERT_EQUAL_size_t(1, HpackPrimV.n);
    TEST_ASSERT_EQUAL_HEX8(0x0a, b[0]);
    HpackPrimV.decode_int_args.in = b;
    HpackPrimV.decode_int_args.len = 1;
    HpackPrimV.decode_int_args.prefix_bits = 5;
    HpackPrimV.decode_int_args.consumed = &consumed;
    HpackPrimV.decode_int_args.value = &v;
    HpackPrim.decode_int(hpack_prim_work);
    TEST_ASSERT_TRUE(HpackPrimV.ok);
    ...
    HpackPrimV.encode_int_args.prefix_bits = 5;
    HpackPrimV.encode_int_args.flags = 0;
    HpackPrimV.encode_int_args.value = 1337;
    HpackPrim.encode_int(hpack_prim_work);
    TEST_ASSERT_EQUAL_size_t(3, HpackPrimV.n);
    TEST_ASSERT_EQUAL_UINT8_ARRAY(C112, b, 3);
    HpackPrimV.decode_int_args.in = C112;
    HpackPrimV.decode_int_args.len = sizeof(C112);
    HpackPrimV.decode_int_args.prefix_bits = 5;
    HpackPrimV.decode_int_args.consumed = &consumed;
    HpackPrimV.decode_int_args.value = &v;
    HpackPrim.decode_int(hpack_prim_work);
    ...
    HpackPrimV.encode_int_args.out = b;
    HpackPrimV.encode_int_args.cap = sizeof(b);
    HpackPrimV.encode_int_args.prefix_bits = 8;
    HpackPrimV.encode_int_args.flags = 0;
    HpackPrimV.encode_int_args.value = 42;
    HpackPrim.encode_int(hpack_prim_work);
    TEST_ASSERT_EQUAL_size_t(1, HpackPrimV.n);
...
void test_prefix_flags_are_left_alone(void)
{
    ...
    HpackPrimV.encode_int_args.cap = sizeof(b);
    HpackPrimV.encode_int_args.prefix_bits = 5;
    HpackPrimV.encode_int_args.flags = 0x20;
    HpackPrimV.encode_int_args.value = 10;
    HpackPrim.encode_int(hpack_prim_work);
    TEST_ASSERT_EQUAL_size_t(1, HpackPrimV.n);
    TEST_ASSERT_EQUAL_HEX8(0x2a, b[0]);
    ...
    HpackPrimV.encode_int_args.value = 2;
    HpackPrim.encode_int(hpack_prim_work);
    TEST_ASSERT_EQUAL_size_t(1, HpackPrimV.n);
...
void test_prefix_int_round_trips_at_every_width(void)
{
    for (uint8_t bits = 1; bits <= 8; bits++)
    {
        ...
        for (size_t i = 0; i < sizeof(VALUES) / sizeof(VALUES[0]); i++)
        {
            ...
            HpackPrimV.encode_int_args.out = b;
            HpackPrimV.encode_int_args.cap = sizeof(b);
            HpackPrimV.encode_int_args.prefix_bits = bits;
            HpackPrimV.encode_int_args.flags = 0;
            HpackPrimV.encode_int_args.value = VALUES[i];
            HpackPrim.encode_int(hpack_prim_work);
            size_t n = HpackPrimV.n;
            TEST_ASSERT_TRUE(n > 0);

            size_t consumed = 0;
            uint32_t got = 0;
            HpackPrimV.decode_int_args.in = b;
            HpackPrimV.decode_int_args.len = n;
            HpackPrimV.decode_int_args.prefix_bits = bits;
            HpackPrimV.decode_int_args.consumed = &consumed;
            HpackPrimV.decode_int_args.value = &got;
            HpackPrim.decode_int(hpack_prim_work);
            TEST_ASSERT_TRUE(HpackPrimV.ok);
...
void test_prefix_int_rejects_an_overflowing_encoding(void)
{
    ...
    HpackPrimV.decode_int_args.in = LARGEST;
    HpackPrimV.decode_int_args.len = sizeof(LARGEST);
    HpackPrimV.decode_int_args.prefix_bits = 5;
    HpackPrimV.decode_int_args.consumed = &consumed;
    HpackPrimV.decode_int_args.value = &v;
    HpackPrim.decode_int(hpack_prim_work);
    ...
    HpackPrimV.decode_int_args.in = JUST_OVER;
    HpackPrimV.decode_int_args.len = sizeof(JUST_OVER);
    HpackPrimV.decode_int_args.prefix_bits = 5;
    HpackPrimV.decode_int_args.consumed = &consumed;
    HpackPrimV.decode_int_args.value = &v;
    HpackPrim.decode_int(hpack_prim_work);
    TEST_ASSERT_FALSE(HpackPrimV.ok);

    static const uint8_t WAY_OVER[6] = {0x1f, 0x80, 0x80, 0x80, 0x80, 0x7f};
    HpackPrimV.decode_int_args.in = WAY_OVER;
    HpackPrimV.decode_int_args.len = sizeof(WAY_OVER);
    HpackPrimV.decode_int_args.prefix_bits = 5;
    HpackPrimV.decode_int_args.consumed = &consumed;
    HpackPrimV.decode_int_args.value = &v;
    HpackPrim.decode_int(hpack_prim_work);
    ...
    HpackPrimV.decode_int_args.in = TOO_LONG;
    HpackPrimV.decode_int_args.len = sizeof(TOO_LONG);
    HpackPrimV.decode_int_args.prefix_bits = 5;
    HpackPrimV.decode_int_args.consumed = &consumed;
    HpackPrimV.decode_int_args.value = &v;
    HpackPrim.decode_int(hpack_prim_work);
    ...
    HpackPrimV.decode_int_args.in = UNTERMINATED;
    HpackPrimV.decode_int_args.len = sizeof(UNTERMINATED);
    HpackPrimV.decode_int_args.prefix_bits = 5;
    HpackPrimV.decode_int_args.consumed = &consumed;
    HpackPrimV.decode_int_args.value = &v;
    HpackPrim.decode_int(hpack_prim_work);
    ...
    HpackPrimV.decode_int_args.in = NO_CONTINUATION;
    HpackPrimV.decode_int_args.len = sizeof(NO_CONTINUATION);
    HpackPrimV.decode_int_args.prefix_bits = 5;
    HpackPrimV.decode_int_args.consumed = &consumed;
    HpackPrimV.decode_int_args.value = &v;
    HpackPrim.decode_int(hpack_prim_work);
    ...
    // Nothing to read.
    HpackPrimV.decode_int_args.in = UNTERMINATED;
    HpackPrimV.decode_int_args.len = 0;
    HpackPrimV.decode_int_args.prefix_bits = 5;
    HpackPrimV.decode_int_args.consumed = &consumed;
    HpackPrimV.decode_int_args.value = &v;
    HpackPrim.decode_int(hpack_prim_work);
...
void test_encode_int_refuses_a_short_buffer(void)
{
    uint8_t b[8];
    HpackPrimV.encode_int_args.out = b;
    HpackPrimV.encode_int_args.cap = 0;
    HpackPrimV.encode_int_args.prefix_bits = 5;
    HpackPrimV.encode_int_args.flags = 0;
    HpackPrimV.encode_int_args.value = 10;
    HpackPrim.encode_int(hpack_prim_work);
    TEST_ASSERT_EQUAL_size_t(0, HpackPrimV.n);
    HpackPrimV.encode_int_args.out = b;
    HpackPrimV.encode_int_args.cap = 1;
    HpackPrimV.encode_int_args.prefix_bits = 5;
    HpackPrimV.encode_int_args.flags = 0;
    HpackPrimV.encode_int_args.value = 1337;
    HpackPrim.encode_int(hpack_prim_work);
    TEST_ASSERT_EQUAL_size_t(0, HpackPrimV.n); // needs three octets
    HpackPrimV.encode_int_args.out = b;
    HpackPrimV.encode_int_args.cap = 2;
    HpackPrimV.encode_int_args.prefix_bits = 5;
    HpackPrimV.encode_int_args.flags = 0;
    HpackPrimV.encode_int_args.value = 1337;
    HpackPrim.encode_int(hpack_prim_work);
    TEST_ASSERT_EQUAL_size_t(0, HpackPrimV.n);
    HpackPrimV.encode_int_args.out = b;
    HpackPrimV.encode_int_args.cap = 3;
    HpackPrimV.encode_int_args.prefix_bits = 5;
    HpackPrimV.encode_int_args.flags = 0;
    HpackPrimV.encode_int_args.value = 1337;
    HpackPrim.encode_int(hpack_prim_work);
    ...
    HpackPrimV.encode_int_args.prefix_bits = 7;
    HpackPrimV.encode_int_args.flags = 0;
    HpackPrimV.encode_int_args.value = 200;
    HpackPrim.encode_int(hpack_prim_work);
    TEST_ASSERT_EQUAL_size_t(0, HpackPrimV.n); // one continuation, no room
}
...
void test_appendix_c_huffman_strings(void)
{
    ...
    for (size_t i = 0; i < sizeof(CASES) / sizeof(CASES[0]); i++)
    {
        ...
        HpackPrimV.huff_len_args.s = CASES[i].text;
        HpackPrimV.huff_len_args.n = len;
        HpackPrim.huff_len(hpack_prim_work);
        TEST_ASSERT_EQUAL_size_t(CASES[i].n, HpackPrimV.n);
        HpackPrimV.huff_encode_args.out = out;
        HpackPrimV.huff_encode_args.cap = sizeof(out);
        HpackPrimV.huff_encode_args.s = CASES[i].text;
        HpackPrimV.huff_encode_args.n = len;
        HpackPrim.huff_encode(hpack_prim_work);
        TEST_ASSERT_EQUAL_size_t(CASES[i].n, HpackPrimV.n);
        TEST_ASSERT_EQUAL_UINT8_ARRAY(CASES[i].want, out, CASES[i].n);

        HpackPrimV.huff_decode_args.in = CASES[i].want;
        HpackPrimV.huff_decode_args.n = CASES[i].n;
        HpackPrimV.huff_decode_args.out = back;
        HpackPrimV.huff_decode_args.cap = sizeof(back);
        HpackPrimV.huff_decode_args.out_len = &back_len;
...
void test_appendix_b_huffman_table(void)
{
    for (int sym = 0; sym < 256; sym++)
    {
        ...
        uint8_t out[8];
        HpackPrimV.huff_len_args.s = &in;
        HpackPrimV.huff_len_args.n = 1;
        HpackPrim.huff_len(hpack_prim_work);
        TEST_ASSERT_EQUAL_size_t(octets, HpackPrimV.n);
        HpackPrimV.huff_encode_args.out = out;
        HpackPrimV.huff_encode_args.cap = sizeof(out);
        HpackPrimV.huff_encode_args.s = &in;
        HpackPrimV.huff_encode_args.n = 1;
        HpackPrim.huff_encode(hpack_prim_work);
        TEST_ASSERT_EQUAL_size_t(octets, HpackPrimV.n);
        ...
        char back[8];
        size_t back_len = 0;
        HpackPrimV.huff_decode_args.in = want;
        HpackPrimV.huff_decode_args.n = octets;
        HpackPrimV.huff_decode_args.out = back;
        HpackPrimV.huff_decode_args.cap = sizeof(back);
        HpackPrimV.huff_decode_args.out_len = &back_len;
        HpackPrim.huff_decode(hpack_prim_work);
...
void test_huffman_decode_rejects_bad_padding_and_eos(void)
{
    ...
    HpackPrimV.huff_decode_args.in = EOS;
    HpackPrimV.huff_decode_args.n = sizeof(EOS);
    HpackPrimV.huff_decode_args.out = out;
    HpackPrimV.huff_decode_args.cap = sizeof(out);
    ...
    HpackPrimV.huff_decode_args.in = PAD_ONES;
    HpackPrimV.huff_decode_args.n = sizeof(PAD_ONES);
    HpackPrimV.huff_decode_args.out = out;
    HpackPrimV.huff_decode_args.cap = sizeof(out);
    HpackPrimV.huff_decode_args.out_len = &out_len;
    HpackPrim.huff_decode(hpack_prim_work);
    ...
    HpackPrimV.huff_decode_args.in = PAD_ZEROS;
    HpackPrimV.huff_decode_args.n = sizeof(PAD_ZEROS);
    HpackPrimV.huff_decode_args.out = out;
    HpackPrimV.huff_decode_args.cap = sizeof(out);
    HpackPrimV.huff_decode_args.out_len = &out_len;
    HpackPrim.huff_decode(hpack_prim_work);
    ...
    HpackPrimV.huff_decode_args.in = PAD_OCTET;
    HpackPrimV.huff_decode_args.n = sizeof(PAD_OCTET);
    HpackPrimV.huff_decode_args.out = out;
    HpackPrimV.huff_decode_args.cap = sizeof(out);
    HpackPrimV.huff_decode_args.out_len = &out_len;
    HpackPrim.huff_decode(hpack_prim_work);
    ...
    char tiny[4];
    HpackPrimV.huff_decode_args.in = WWW;
    HpackPrimV.huff_decode_args.n = sizeof(WWW);
    HpackPrimV.huff_decode_args.out = tiny;
    HpackPrimV.huff_decode_args.cap = sizeof(tiny);
    HpackPrimV.huff_decode_args.out_len = &out_len;
    HpackPrim.huff_decode(hpack_prim_work);
    TEST_ASSERT_FALSE(HpackPrimV.ok);
}
...
void test_huff_encode_refuses_a_short_buffer(void)
{
    uint8_t out[16];
    HpackPrimV.huff_encode_args.out = out;
    HpackPrimV.huff_encode_args.cap = 0;
    HpackPrimV.huff_encode_args.s = "www.example.com";
    HpackPrimV.huff_encode_args.n = 15;
    HpackPrim.huff_encode(hpack_prim_work);
    TEST_ASSERT_EQUAL_size_t(0, HpackPrimV.n);
    HpackPrimV.huff_encode_args.out = out;
    HpackPrimV.huff_encode_args.cap = 11;
    HpackPrimV.huff_encode_args.s = "www.example.com";
    HpackPrimV.huff_encode_args.n = 15;
    HpackPrim.huff_encode(hpack_prim_work);
    TEST_ASSERT_EQUAL_size_t(0, HpackPrimV.n); // needs twelve
    HpackPrimV.huff_encode_args.out = out;
    HpackPrimV.huff_encode_args.cap = 12;
    HpackPrimV.huff_encode_args.s = "www.example.com";
    HpackPrimV.huff_encode_args.n = 15;
    HpackPrim.huff_encode(hpack_prim_work);
    TEST_ASSERT_EQUAL_size_t(12, HpackPrimV.n);
    HpackPrimV.huff_encode_args.out = out;
    HpackPrimV.huff_encode_args.cap = 0;
    HpackPrimV.huff_encode_args.s = "a";
    HpackPrimV.huff_encode_args.n = 1;
    HpackPrim.huff_encode(hpack_prim_work);
    TEST_ASSERT_EQUAL_size_t(0, HpackPrimV.n); // no room for the last octet
}
...
void test_decode_str_reads_both_forms(void)
{
    ...
    HpackPrimV.decode_str_args.block = RAW;
    HpackPrimV.decode_str_args.len = sizeof(RAW);
    HpackPrimV.decode_str_args.pos = &pos;
    HpackPrimV.decode_str_args.out = out;
    HpackPrimV.decode_str_args.cap = sizeof(out);
    HpackPrimV.decode_str_args.out_len = &out_len;
    ...
    pos = 0;
    HpackPrimV.decode_str_args.block = HUFF;
    HpackPrimV.decode_str_args.len = sizeof(HUFF);
    HpackPrimV.decode_str_args.pos = &pos;
    HpackPrimV.decode_str_args.out = out;
    HpackPrimV.decode_str_args.cap = sizeof(out);
    HpackPrimV.decode_str_args.out_len = &out_len;
    ...
    pos = 0;
    HpackPrimV.decode_str_args.block = SEQ;
    HpackPrimV.decode_str_args.len = sizeof(SEQ);
    HpackPrimV.decode_str_args.pos = &pos;
    HpackPrimV.decode_str_args.out = out;
    HpackPrimV.decode_str_args.cap = sizeof(out);
    HpackPrimV.decode_str_args.out_len = &out_len;
...
void test_decode_str_fails_closed(void)
{
    ...
    HpackPrimV.decode_str_args.block = OVER_BLOCK;
    HpackPrimV.decode_str_args.len = sizeof(OVER_BLOCK);
    HpackPrimV.decode_str_args.pos = &pos;
    HpackPrimV.decode_str_args.out = out;
    HpackPrimV.decode_str_args.cap = sizeof(out);
    HpackPrimV.decode_str_args.out_len = &out_len;
    ...
    char tiny[4];
    HpackPrimV.decode_str_args.block = TEN;
    HpackPrimV.decode_str_args.len = sizeof(TEN);
    HpackPrimV.decode_str_args.pos = &pos;
    HpackPrimV.decode_str_args.out = tiny;
    HpackPrimV.decode_str_args.cap = sizeof(tiny);
    HpackPrimV.decode_str_args.out_len = &out_len;
    HpackPrim.decode_str(hpack_prim_work);
    TEST_ASSERT_FALSE(HpackPrimV.ok);
    ...
    HpackPrimV.decode_str_args.block = ONE;
    HpackPrimV.decode_str_args.len = 0;
    HpackPrimV.decode_str_args.pos = &pos;
    HpackPrimV.decode_str_args.out = out;
    HpackPrimV.decode_str_args.cap = sizeof(out);
    HpackPrimV.decode_str_args.out_len = &out_len;
    HpackPrim.decode_str(hpack_prim_work);
    TEST_ASSERT_FALSE(HpackPrimV.ok); // nothing to read

    // A length prefix whose continuation never terminates.
    pos = 0;
    static const uint8_t BAD_LEN[2] = {0xff, 0x80};
    HpackPrimV.decode_str_args.block = BAD_LEN;
    HpackPrimV.decode_str_args.len = sizeof(BAD_LEN);
    HpackPrimV.decode_str_args.pos = &pos;
    HpackPrimV.decode_str_args.out = out;
    HpackPrimV.decode_str_args.cap = sizeof(out);
    HpackPrimV.decode_str_args.out_len = &out_len;
    ...
    HpackPrimV.decode_str_args.block = BAD_PAD;
    HpackPrimV.decode_str_args.len = sizeof(BAD_PAD);
    HpackPrimV.decode_str_args.pos = &pos;
    HpackPrimV.decode_str_args.out = out;
    HpackPrimV.decode_str_args.cap = sizeof(out);
    HpackPrimV.decode_str_args.out_len = &out_len;
...
void test_encode_str_picks_the_shorter_form(void)
{
    ...
    HpackPrimV.encode_str_args.out = out;
    HpackPrimV.encode_str_args.cap = sizeof(out);
    HpackPrimV.encode_str_args.s = "www.example.com";
    HpackPrimV.encode_str_args.n = 15;
    HpackPrim.encode_str(hpack_prim_work);
    size_t n = HpackPrimV.n;
    TEST_ASSERT_EQUAL_size_t(13, n);
    TEST_ASSERT_EQUAL_HEX8(0x8c, out[0]);
    HpackPrimV.decode_str_args.block = out;
    HpackPrimV.decode_str_args.len = n;
    HpackPrimV.decode_str_args.pos = &pos;
    HpackPrimV.decode_str_args.out = back;
    HpackPrimV.decode_str_args.cap = sizeof(back);
    HpackPrimV.decode_str_args.out_len = &back_len;
    HpackPrim.decode_str(hpack_prim_work);
    TEST_ASSERT_TRUE(HpackPrimV.ok);
    ...
    HpackPrimV.encode_str_args.out = out;
    HpackPrimV.encode_str_args.cap = sizeof(out);
    HpackPrimV.encode_str_args.s = WIDE;
    HpackPrimV.encode_str_args.n = sizeof(WIDE);
    HpackPrim.encode_str(hpack_prim_work);
    n = HpackPrimV.n;
    ...
    HpackPrimV.encode_str_args.out = out;
    HpackPrimV.encode_str_args.cap = sizeof(out);
    HpackPrimV.encode_str_args.s = "";
    HpackPrimV.encode_str_args.n = 0;
    HpackPrim.encode_str(hpack_prim_work);
    n = HpackPrimV.n;
    ...
    HpackPrimV.encode_str_args.out = out;
    HpackPrimV.encode_str_args.cap = 4;
    HpackPrimV.encode_str_args.s = "www.example.com";
    HpackPrimV.encode_str_args.n = 15;
    HpackPrim.encode_str(hpack_prim_work);
    TEST_ASSERT_EQUAL_size_t(0, HpackPrimV.n);
    HpackPrimV.encode_str_args.out = out;
    HpackPrimV.encode_str_args.cap = 0;
    HpackPrimV.encode_str_args.s = "x";
    HpackPrimV.encode_str_args.n = 1;
    HpackPrim.encode_str(hpack_prim_work);
    TEST_ASSERT_EQUAL_size_t(0, HpackPrimV.n);
}
...
void test_encode_str_round_trips_every_octet(void)
{
    ...
    uint8_t block[1024];
    HpackPrimV.encode_str_args.out = block;
    HpackPrimV.encode_str_args.cap = sizeof(block);
    HpackPrimV.encode_str_args.s = in;
    HpackPrimV.encode_str_args.n = sizeof(in);
    HpackPrim.encode_str(hpack_prim_work);
    size_t n = HpackPrimV.n;
    TEST_ASSERT_TRUE(n > 0);
