...
void test_rfc9147_4_plaintext_record_layout(void)
{
    ...
    DtlsRecordV.plaintext_build_args.epoch = 0x0102;
    DtlsRecordV.plaintext_build_args.seq = 0x0000AABBCCDDull;
    DtlsRecordV.plaintext_build_args.fragment = MSG;
    DtlsRecordV.plaintext_build_args.frag_len = sizeof(MSG);
    DtlsRecordV.plaintext_build_args.out = g_out;
    DtlsRecordV.plaintext_build_args.out_cap = sizeof(g_out);
    DtlsRecord.plaintext_build(dtls_record_work);
    size_t n = DtlsRecordV.n;
    ...
    DtlsPlaintext view;
    DtlsRecordV.plaintext_parse_args.rec = g_out;
    DtlsRecordV.plaintext_parse_args.rec_len = n;
    DtlsRecordV.plaintext_parse_args.out = &view;
    DtlsRecord.plaintext_parse(dtls_record_work);
    TEST_ASSERT_EQUAL_UINT(n, DtlsRecordV.n);
...
{
    DtlsRecordV.plaintext_build_args.content_type = PROTOCORE_DTLS_CT_ACK;
    DtlsRecordV.plaintext_build_args.epoch = 0;
    ...
    {
        DtlsRecordV.plaintext_parse_args.rec = g_out;
        DtlsRecordV.plaintext_parse_args.rec_len = take;
        DtlsRecordV.plaintext_parse_args.out = &view;
        DtlsRecord.plaintext_parse(dtls_record_work);
        TEST_ASSERT_EQUAL_UINT(0u, DtlsRecordV.n);
    }
    DtlsRecordV.plaintext_parse_args.rec = g_out;
    DtlsRecordV.plaintext_parse_args.rec_len = n;
    DtlsRecordV.plaintext_parse_args.out = &view;
    ...
    TEST_ASSERT_EQUAL_UINT(n, DtlsRecordV.n);
    DtlsRecordV.plaintext_parse_args.rec = g_out;
    DtlsRecordV.plaintext_parse_args.rec_len = n + 40;
    DtlsRecordV.plaintext_parse_args.out = &view;
    DtlsRecord.plaintext_parse(dtls_record_work);
    TEST_ASSERT_EQUAL_UINT(n, DtlsRecordV.n);
    ...
    DtlsRecordV.plaintext_build_args.frag_len = sizeof(MSG);
    DtlsRecordV.plaintext_build_args.out = g_out;
    DtlsRecordV.plaintext_build_args.out_cap = n - 1;
    DtlsRecord.plaintext_build(dtls_record_work);
    TEST_ASSERT_EQUAL_UINT(0u, DtlsRecordV.n);
    DtlsRecordV.plaintext_build_args.content_type = PROTOCORE_DTLS_CT_ACK;
    DtlsRecordV.plaintext_build_args.epoch = 0;
    ...
    DtlsRecordV.plaintext_build_args.frag_len = sizeof(MSG);
    DtlsRecordV.plaintext_build_args.out = g_out;
    DtlsRecordV.plaintext_build_args.out_cap = n;
    DtlsRecord.plaintext_build(dtls_record_work);
    TEST_ASSERT_EQUAL_UINT(n, DtlsRecordV.n);
}
...
{
    DtlsRecordV.protect_args.keys = &g_keys;
    DtlsRecordV.protect_args.seq = 0x1234;
    DtlsRecordV.protect_args.content_type = PROTOCORE_DTLS_CT_APPLICATION_DATA;
    DtlsRecordV.protect_args.plaintext = MSG;
    DtlsRecordV.protect_args.pt_len = sizeof(MSG);
    DtlsRecordV.protect_args.out = g_out;
    DtlsRecordV.protect_args.out_cap = sizeof(g_out);
    ...
    DtlsRecordV.keys_derive_args.out = &e4;
    DtlsRecordV.keys_derive_args.cipher = DTLS_CIPHER_AES_128_GCM_SHA256;
    DtlsRecordV.keys_derive_args.epoch = 4;
    DtlsRecordV.keys_derive_args.secret = SECRET;
    DtlsRecord.keys_derive(dtls_record_work);
    DtlsRecordV.protect_args.keys = &e4;
...
void test_rfc9147_4_2_3_sequence_number_encryption(void)
{
    ...
    uint8_t pt[64];
    DtlsCiphertext info;
    DtlsRecordV.unprotect_args.keys = &g_keys;
    DtlsRecordV.unprotect_args.next_seq = SEQ;
    DtlsRecordV.unprotect_args.rec = g_out;
    DtlsRecordV.unprotect_args.rec_len = n;
    ...
    DtlsRecordV.protect_args.seq = SEQ;
    DtlsRecordV.protect_args.content_type = PROTOCORE_DTLS_CT_APPLICATION_DATA;
    DtlsRecordV.protect_args.plaintext = MSG2;
    DtlsRecordV.protect_args.pt_len = sizeof(MSG2);
    DtlsRecordV.protect_args.out = other;
    DtlsRecordV.protect_args.out_cap = sizeof(other);
    DtlsRecordV.protect_args.cid = NULL;
    DtlsRecordV.protect_args.cid_len = 0;
    DtlsRecord.protect(dtls_record_work);
    size_t m = DtlsRecordV.n;
...
void test_rfc9147_4_2_2_sequence_reconstruction(void)
{
    ...
    {
        DtlsRecordV.protect_args.keys = &g_keys;
        DtlsRecordV.protect_args.seq = SEQS[i];
        DtlsRecordV.protect_args.content_type = PROTOCORE_DTLS_CT_APPLICATION_DATA;
        DtlsRecordV.protect_args.plaintext = MSG;
        DtlsRecordV.protect_args.pt_len = sizeof(MSG);
        DtlsRecordV.protect_args.out = g_out;
        ...
        DtlsRecordV.unprotect_args.keys = &g_keys;
        DtlsRecordV.unprotect_args.next_seq = SEQS[i];
        DtlsRecordV.unprotect_args.rec = g_out;
        DtlsRecordV.unprotect_args.rec_len = n;
        DtlsRecordV.unprotect_args.out = pt;
        DtlsRecordV.unprotect_args.out_cap = sizeof(pt);
    ...
    DtlsRecordV.protect_args.keys = &g_keys;
    DtlsRecordV.protect_args.seq = 0x10000 - 100;
    DtlsRecordV.protect_args.content_type = PROTOCORE_DTLS_CT_APPLICATION_DATA;
    DtlsRecordV.protect_args.plaintext = MSG;
    DtlsRecordV.protect_args.pt_len = sizeof(MSG);
    DtlsRecordV.protect_args.out = g_out;
    ...
    size_t n = DtlsRecordV.n;
    DtlsRecordV.unprotect_args.keys = &g_keys;
    DtlsRecordV.unprotect_args.next_seq = 0x10000;
    DtlsRecordV.unprotect_args.rec = g_out;
    DtlsRecordV.unprotect_args.rec_len = n;
    DtlsRecordV.unprotect_args.out = pt;
    DtlsRecordV.unprotect_args.out_cap = sizeof(pt);
...
void test_a_wrong_sequence_number_fails_deprotection(void)
{
    ...
    DtlsCiphertext info;
    DtlsRecordV.protect_args.keys = &g_keys;
    DtlsRecordV.protect_args.seq = 0x10000;
    DtlsRecordV.protect_args.content_type = PROTOCORE_DTLS_CT_APPLICATION_DATA;
    DtlsRecordV.protect_args.plaintext = MSG;
    DtlsRecordV.protect_args.pt_len = sizeof(MSG);
    DtlsRecordV.protect_args.out = g_out;
    ...
    DtlsRecordV.unprotect_args.keys = &g_keys;
    DtlsRecordV.unprotect_args.next_seq = 0x30000;
    DtlsRecordV.unprotect_args.rec = g_out;
    DtlsRecordV.unprotect_args.rec_len = n;
    DtlsRecordV.unprotect_args.out = pt;
    DtlsRecordV.unprotect_args.out_cap = sizeof(pt);
    ...
    DtlsRecordV.unprotect_args.expected_cid_len = 0;
    DtlsRecord.unprotect(dtls_record_work);
    TEST_ASSERT_FALSE(DtlsRecordV.ok);
...
void test_epoch_bits_select_the_keys(void)
{
    ...
    DtlsCiphertext info;
    DtlsRecordV.protect_args.keys = &g_keys;
    DtlsRecordV.protect_args.seq = 7;
    DtlsRecordV.protect_args.content_type = PROTOCORE_DTLS_CT_APPLICATION_DATA;
    DtlsRecordV.protect_args.plaintext = MSG;
    DtlsRecordV.protect_args.pt_len = sizeof(MSG);
    DtlsRecordV.protect_args.out = g_out;
    ...
    DtlsRecordV.keys_derive_args.out = &other;
    DtlsRecordV.keys_derive_args.cipher = DTLS_CIPHER_AES_128_GCM_SHA256;
    DtlsRecordV.keys_derive_args.epoch = 2;
    DtlsRecordV.keys_derive_args.secret = SECRET;
    DtlsRecord.keys_derive(dtls_record_work); // low bits 10, not 11
    DtlsRecordV.unprotect_args.keys = &other;
    DtlsRecordV.unprotect_args.next_seq = 7;
    DtlsRecordV.unprotect_args.rec = g_out;
    DtlsRecordV.unprotect_args.rec_len = n;
    DtlsRecordV.unprotect_args.out = pt;
    DtlsRecordV.unprotect_args.out_cap = sizeof(pt);
    ...
    DtlsRecordV.keys_derive_args.out = &e7;
    DtlsRecordV.keys_derive_args.cipher = DTLS_CIPHER_AES_128_GCM_SHA256;
    DtlsRecordV.keys_derive_args.epoch = 7;
    DtlsRecordV.keys_derive_args.secret = OTHER_SECRET;
    DtlsRecord.keys_derive(dtls_record_work);
    DtlsRecordV.unprotect_args.keys = &e7;
    DtlsRecordV.unprotect_args.next_seq = 7;
    DtlsRecordV.unprotect_args.rec = g_out;
    DtlsRecordV.unprotect_args.rec_len = n;
    DtlsRecordV.unprotect_args.out = pt;
...
void test_rfc9146_connection_id(void)
{
    ...
    DtlsRecordV.protect_args.keys = &g_keys;
    DtlsRecordV.protect_args.seq = 5;
    DtlsRecordV.protect_args.content_type = PROTOCORE_DTLS_CT_APPLICATION_DATA;
    DtlsRecordV.protect_args.plaintext = MSG;
    DtlsRecordV.protect_args.pt_len = sizeof(MSG);
    DtlsRecordV.protect_args.out = g_out;
    DtlsRecordV.protect_args.out_cap = sizeof(g_out);
    DtlsRecordV.protect_args.cid = CID;
    DtlsRecordV.protect_args.cid_len = sizeof(CID);
    DtlsRecord.protect(dtls_record_work);
    size_t n = DtlsRecordV.n;
    ...
    DtlsRecordV.unprotect_args.keys = &g_keys;
    DtlsRecordV.unprotect_args.next_seq = 5;
    DtlsRecordV.unprotect_args.rec = g_out;
    DtlsRecordV.unprotect_args.rec_len = n;
    DtlsRecordV.unprotect_args.out = pt;
    DtlsRecordV.unprotect_args.out_cap = sizeof(pt);
    DtlsRecordV.unprotect_args.info = &info;
    DtlsRecordV.unprotect_args.expected_cid = CID;
    DtlsRecordV.unprotect_args.expected_cid_len = sizeof(CID);
    DtlsRecord.unprotect(dtls_record_work);
    TEST_ASSERT_TRUE(DtlsRecordV.ok);
    TEST_ASSERT_EQUAL_UINT(sizeof(MSG), info.pt_len);
    TEST_ASSERT_EQUAL_UINT8_ARRAY(MSG, pt, sizeof(MSG));
    ...
    DtlsRecordV.unprotect_args.out_cap = sizeof(pt);
    DtlsRecordV.unprotect_args.info = &info;
    DtlsRecordV.unprotect_args.expected_cid = WRONG_CID;
    DtlsRecordV.unprotect_args.expected_cid_len = sizeof(WRONG_CID);
    DtlsRecord.unprotect(dtls_record_work);
    TEST_ASSERT_FALSE(DtlsRecordV.ok);
    ...
    DtlsRecordV.unprotect_args.next_seq = 5;
    DtlsRecordV.unprotect_args.rec = g_out;
    DtlsRecordV.unprotect_args.rec_len = m;
    DtlsRecordV.unprotect_args.out = pt;
    DtlsRecordV.unprotect_args.out_cap = sizeof(pt);
    DtlsRecordV.unprotect_args.info = &info;
    DtlsRecordV.unprotect_args.expected_cid = CID;
    ...
    DtlsRecordV.protect_args.out = g_out;
    DtlsRecordV.protect_args.out_cap = sizeof(g_out);
    DtlsRecordV.protect_args.cid = big;
    DtlsRecordV.protect_args.cid_len = sizeof(big);
    DtlsRecord.protect(dtls_record_work);
    TEST_ASSERT_EQUAL_UINT(0u, DtlsRecordV.n);
    DtlsRecordV.unprotect_args.keys = &g_keys;
    DtlsRecordV.unprotect_args.next_seq = 5;
    ...
    DtlsRecordV.unprotect_args.out_cap = sizeof(pt);
    DtlsRecordV.unprotect_args.info = &info;
    DtlsRecordV.unprotect_args.expected_cid = big;
    DtlsRecordV.unprotect_args.expected_cid_len = sizeof(big);
    DtlsRecord.unprotect(dtls_record_work);
    TEST_ASSERT_FALSE(DtlsRecordV.ok);
}
...
void test_inner_content_type_and_padding(void)
{
    ...
    {
        DtlsRecordV.protect_args.keys = &g_keys;
        DtlsRecordV.protect_args.seq = i;
        DtlsRecordV.protect_args.content_type = TYPES[i];
        DtlsRecordV.protect_args.plaintext = MSG;
        DtlsRecordV.protect_args.pt_len = sizeof(MSG);
        DtlsRecordV.protect_args.out = g_out;
        DtlsRecordV.protect_args.out_cap = sizeof(g_out);
        ...
        TEST_ASSERT_TRUE(n > 0);
        DtlsRecordV.unprotect_args.keys = &g_keys;
        DtlsRecordV.unprotect_args.next_seq = i;
        DtlsRecordV.unprotect_args.rec = g_out;
        DtlsRecordV.unprotect_args.rec_len = n;
        DtlsRecordV.unprotect_args.out = pt;
        DtlsRecordV.unprotect_args.out_cap = sizeof(pt);
    ...
    DtlsRecordV.protect_args.keys = &g_keys;
    DtlsRecordV.protect_args.seq = 9;
    DtlsRecordV.protect_args.content_type = 0x00;
    DtlsRecordV.protect_args.plaintext = INNER;
    DtlsRecordV.protect_args.pt_len = sizeof(INNER);
    DtlsRecordV.protect_args.out = g_out;
    DtlsRecordV.protect_args.out_cap = sizeof(g_out);
    DtlsRecordV.protect_args.cid = NULL;
    DtlsRecordV.protect_args.cid_len = 0;
    ...
    TEST_ASSERT_TRUE(n > 0);
    DtlsRecordV.unprotect_args.keys = &g_keys;
    DtlsRecordV.unprotect_args.next_seq = 9;
    DtlsRecordV.unprotect_args.rec = g_out;
    DtlsRecordV.unprotect_args.rec_len = n;
    DtlsRecordV.unprotect_args.out = pt;
    DtlsRecordV.unprotect_args.out_cap = sizeof(pt);
    ...
    DtlsRecordV.protect_args.keys = &g_keys;
    DtlsRecordV.protect_args.seq = 10;
    DtlsRecordV.protect_args.content_type = 0x00;
    DtlsRecordV.protect_args.plaintext = &ZERO;
    DtlsRecordV.protect_args.pt_len = 1;
    DtlsRecordV.protect_args.out = g_out;
    DtlsRecordV.protect_args.out_cap = sizeof(g_out);
    DtlsRecordV.protect_args.cid = NULL;
    DtlsRecordV.protect_args.cid_len = 0;
    ...
    TEST_ASSERT_TRUE(n > 0);
    DtlsRecordV.unprotect_args.keys = &g_keys;
    DtlsRecordV.unprotect_args.next_seq = 10;
    DtlsRecordV.unprotect_args.rec = g_out;
    DtlsRecordV.unprotect_args.rec_len = n;
    DtlsRecordV.unprotect_args.out = pt;
    DtlsRecordV.unprotect_args.out_cap = sizeof(pt);
...
void test_rfc9147_4_5_2_invalid_records(void)
{
    ...
    DtlsCiphertext info;
    DtlsRecordV.protect_args.keys = &g_keys;
    DtlsRecordV.protect_args.seq = 11;
    DtlsRecordV.protect_args.content_type = PROTOCORE_DTLS_CT_APPLICATION_DATA;
    DtlsRecordV.protect_args.plaintext = MSG;
    DtlsRecordV.protect_args.pt_len = sizeof(MSG);
    DtlsRecordV.protect_args.out = g_out;
    ...
    for (uint8_t top = 0; top < 8; top++)
    {
        ...
        DtlsRecordV.unprotect_args.keys = &g_keys;
        DtlsRecordV.unprotect_args.next_seq = 11;
    ...
    for (size_t i = 0; i < n; i++)
    {
        ...
        DtlsRecordV.unprotect_args.expected_cid_len = 0;
        DtlsRecord.unprotect(dtls_record_work);
        TEST_ASSERT_FALSE_MESSAGE(DtlsRecordV.ok, "a flipped bit must not deprotect");
    }
    ...
    for (size_t take = 0; take < n; take++)
    {
        ...
        DtlsRecordV.unprotect_args.next_seq = 11;
        DtlsRecordV.unprotect_args.rec = g_out;
        DtlsRecordV.unprotect_args.rec_len = take;
        DtlsRecordV.unprotect_args.out = pt;
        DtlsRecordV.unprotect_args.out_cap = sizeof(pt);
        DtlsRecordV.unprotect_args.info = &info;
        DtlsRecordV.unprotect_args.expected_cid = NULL;
    ...
    DtlsRecordV.unprotect_args.rec_len = n;
    DtlsRecordV.unprotect_args.out = pt;
    DtlsRecordV.unprotect_args.out_cap = 4;
    DtlsRecordV.unprotect_args.info = &info;
    DtlsRecordV.unprotect_args.expected_cid = NULL;
    DtlsRecordV.unprotect_args.expected_cid_len = 0;
    DtlsRecord.unprotect(dtls_record_work);
    ...
    DtlsRecordV.protect_args.pt_len = sizeof(MSG);
    DtlsRecordV.protect_args.out = g_out;
    DtlsRecordV.protect_args.out_cap = n - 1;
    DtlsRecordV.protect_args.cid = NULL;
    DtlsRecordV.protect_args.cid_len = 0;
    DtlsRecord.protect(dtls_record_work);
    TEST_ASSERT_EQUAL_UINT(0u, DtlsRecordV.n);
...
{
    DtlsReplayWindow w;
    DtlsRecordV.replay_init_args.w = &w;
    ...
    DtlsRecordV.replay_check_args.w = &w;
    DtlsRecordV.replay_check_args.seq = 0;
    DtlsRecord.replay_check(dtls_record_work);
    TEST_ASSERT_TRUE(DtlsRecordV.ok);
    DtlsRecordV.replay_check_args.w = &w;
    DtlsRecordV.replay_check_args.seq = 1000;
    DtlsRecord.replay_check(dtls_record_work);
    TEST_ASSERT_TRUE(DtlsRecordV.ok);
    DtlsRecordV.replay_mark_args.w = &w;
    DtlsRecordV.replay_mark_args.seq = 0;
    DtlsRecord.replay_mark(dtls_record_work);
    DtlsRecordV.replay_check_args.w = &w;
    DtlsRecordV.replay_check_args.seq = 0;
    DtlsRecord.replay_check(dtls_record_work);
    TEST_ASSERT_FALSE(DtlsRecordV.ok); // now a duplicate

    // Ahead of the right edge is new; a gap is allowed and the skipped numbers stay acceptable.
    DtlsRecordV.replay_check_args.w = &w;
    DtlsRecordV.replay_check_args.seq = 5;
    DtlsRecord.replay_check(dtls_record_work);
    TEST_ASSERT_TRUE(DtlsRecordV.ok);
    DtlsRecordV.replay_mark_args.w = &w;
    DtlsRecordV.replay_mark_args.seq = 5;
    DtlsRecord.replay_mark(dtls_record_work);
    DtlsRecordV.replay_check_args.w = &w;
    DtlsRecordV.replay_check_args.seq = 5;
    DtlsRecord.replay_check(dtls_record_work);
    TEST_ASSERT_FALSE(DtlsRecordV.ok);
    DtlsRecordV.replay_check_args.w = &w;
    DtlsRecordV.replay_check_args.seq = 3;
    DtlsRecord.replay_check(dtls_record_work);
    TEST_ASSERT_TRUE(DtlsRecordV.ok); // reordered, inside the window, not yet seen
    DtlsRecordV.replay_mark_args.w = &w;
    DtlsRecordV.replay_mark_args.seq = 3;
    DtlsRecord.replay_mark(dtls_record_work);
    DtlsRecordV.replay_check_args.w = &w;
    DtlsRecordV.replay_check_args.seq = 3;
    DtlsRecord.replay_check(dtls_record_work);
    ...
    TEST_ASSERT_FALSE(DtlsRecordV.ok);
    DtlsRecordV.replay_check_args.w = &w;
    DtlsRecordV.replay_check_args.seq = 4;
    DtlsRecord.replay_check(dtls_record_work);
    TEST_ASSERT_TRUE(DtlsRecordV.ok);
    ...
    // still inside.
    DtlsRecordV.replay_mark_args.w = &w;
    DtlsRecordV.replay_mark_args.seq = 69;
    DtlsRecord.replay_mark(dtls_record_work);
    DtlsRecordV.replay_check_args.w = &w;
    DtlsRecordV.replay_check_args.seq = 5;
    DtlsRecord.replay_check(dtls_record_work);
    TEST_ASSERT_FALSE(DtlsRecordV.ok); // 69 - 5 = 64: outside
    DtlsRecordV.replay_check_args.w = &w;
    DtlsRecordV.replay_check_args.seq = 6;
    DtlsRecord.replay_check(dtls_record_work);
    TEST_ASSERT_TRUE(DtlsRecordV.ok); // 69 - 6 = 63: the oldest bit
    DtlsRecordV.replay_check_args.w = &w;
    DtlsRecordV.replay_check_args.seq = 69;
    DtlsRecord.replay_check(dtls_record_work);
    TEST_ASSERT_FALSE(DtlsRecordV.ok);

    // A jump of more than the window width clears everything behind it.
    DtlsRecordV.replay_mark_args.w = &w;
    DtlsRecordV.replay_mark_args.seq = 1000;
    DtlsRecord.replay_mark(dtls_record_work);
    DtlsRecordV.replay_check_args.w = &w;
    DtlsRecordV.replay_check_args.seq = 1000;
    DtlsRecord.replay_check(dtls_record_work);
    ...
    TEST_ASSERT_FALSE(DtlsRecordV.ok);
    DtlsRecordV.replay_check_args.w = &w;
    DtlsRecordV.replay_check_args.seq = 936;
    DtlsRecord.replay_check(dtls_record_work);
    TEST_ASSERT_FALSE(DtlsRecordV.ok); // 1000 - 936 = 64: outside
    DtlsRecordV.replay_check_args.w = &w;
    DtlsRecordV.replay_check_args.seq = 937;
    DtlsRecord.replay_check(dtls_record_work);
    TEST_ASSERT_TRUE(DtlsRecordV.ok);
    DtlsRecordV.replay_check_args.w = &w;
    DtlsRecordV.replay_check_args.seq = 1001;
    DtlsRecord.replay_check(dtls_record_work);
    TEST_ASSERT_TRUE(DtlsRecordV.ok);
...
void test_round_trip_over_lengths(void)
{
    ...
    {
        DtlsRecordV.protect_args.keys = &g_keys;
        DtlsRecordV.protect_args.seq = len;
        DtlsRecordV.protect_args.content_type = PROTOCORE_DTLS_CT_APPLICATION_DATA;
        DtlsRecordV.protect_args.plaintext = src;
        ...
        TEST_ASSERT_TRUE(n > 0);
        DtlsRecordV.unprotect_args.keys = &g_keys;
        DtlsRecordV.unprotect_args.next_seq = len;
        DtlsRecordV.unprotect_args.rec = g_out;
        DtlsRecordV.unprotect_args.rec_len = n;
        DtlsRecordV.unprotect_args.out = pt;
        DtlsRecordV.unprotect_args.out_cap = sizeof(pt);
