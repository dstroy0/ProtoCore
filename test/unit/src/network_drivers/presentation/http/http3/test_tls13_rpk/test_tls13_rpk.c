...
void test_rfc8410_ed25519_spki(void)
{
    ...
    Tls13Rpk.ed25519_spki_args.out = g_out;
    Tls13Rpk.ed25519_spki_args.cap = sizeof(g_out);
    Tls13Rpk.ed25519_spki_args.pub = RFC8410_SPKI + 12;
    Tls13Rpk.ed25519_spki(tls13_rpk_work);
    TEST_ASSERT_EQUAL_UINT(44u, Tls13Rpk.n);
    TEST_ASSERT_EQUAL_MEMORY(RFC8410_SPKI, g_out, 44);

    Tls13Rpk.ed25519_spki_args.out = g_out;
    Tls13Rpk.ed25519_spki_args.cap = 43;
    Tls13Rpk.ed25519_spki_args.pub = RFC8410_SPKI + 12;
    Tls13Rpk.ed25519_spki(tls13_rpk_work);
...
void test_rpk_certificate_round_trip(void)
{
    ...
    uint8_t msg[128];
    Tls13Rpk.build_certificate_args.out = msg;
    Tls13Rpk.build_certificate_args.cap = sizeof(msg);
    ...
    Tls13Msg.parse_certificate_args.len = n;
    Tls13Msg.parse_certificate_args.cert = &cert;
    Tls13Msg.parse_certificate_args.cert_len = &cert_len;
    ...
    Tls13Rpk.ed25519_from_spki_args.spki = cert;
    Tls13Rpk.ed25519_from_spki_args.len = cert_len;
    Tls13Rpk.ed25519_from_spki_args.pub = &got;
    Tls13Rpk.ed25519_from_spki(tls13_rpk_work);
    TEST_ASSERT_TRUE(Tls13Rpk.ok);
...
void test_x509_certificate_is_not_read_as_a_raw_public_key(void)
{
    ...
    uint8_t msg[128];
    Tls13Msg.build_certificate_args.out = msg;
    Tls13Msg.build_certificate_args.cap = sizeof(msg);
...
void test_spki_reader_refuses_a_wrong_prefix(void)
{
    ...
    Tls13Rpk.ed25519_spki_args.pub = pub;
    Tls13Rpk.ed25519_spki(tls13_rpk_work);
    TEST_ASSERT_NOT_EQUAL(0u, Tls13Rpk.n);

    const uint8_t *got = NULL;
    Tls13Rpk.ed25519_from_spki_args.spki = spki;
    Tls13Rpk.ed25519_from_spki_args.len = sizeof(spki);
    Tls13Rpk.ed25519_from_spki_args.pub = &got;
    Tls13Rpk.ed25519_from_spki(tls13_rpk_work);
    TEST_ASSERT_TRUE(Tls13Rpk.ok);
    TEST_ASSERT_EQUAL_UINT8_ARRAY(pub, got, 32);
    ...
    spki[6] ^= 0x01;
    Tls13Rpk.ed25519_from_spki_args.spki = spki;
    Tls13Rpk.ed25519_from_spki_args.len = sizeof(spki) - 1;
    Tls13Rpk.ed25519_from_spki_args.pub = &got;
    Tls13Rpk.ed25519_from_spki(tls13_rpk_work);
    TEST_ASSERT_FALSE(Tls13Rpk.ok);
}
