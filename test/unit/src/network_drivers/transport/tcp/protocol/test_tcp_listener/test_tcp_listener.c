...
void test_accept_tags_the_ingress_interface(void)
{
    ...
    TEST_ASSERT_EQUAL(PROTOCORE_IF_WIFI_AP, ConnPoolV.if_kind);
}
...
void test_accept_tags_a_station_connection_when_no_access_point_matches(void)
{
    ...
    ConnPoolV.slot = 0;
    ConnPool.iface(protocore_conn_pool_span());
    TEST_ASSERT_EQUAL(PROTOCORE_IF_WIFI_STA, ConnPoolV.if_kind);
}
...
{
    TcpListenerV.idx = 1;
    TcpListenerV.bind.port = 23;
    TcpListenerV.bind.proto = PROTO_TELNET;
    TcpListenerV.bind.tls = PROTO_FALSE;
    TcpListener.add(protocore_tcp_listener_span());
    protocore_pcb second;
    memset(&second, 0, sizeof(second));
...
void test_a_listener_dscp_is_masked_to_six_bits(void)
{
    ...
    TcpListener.set_dscp(protocore_tcp_listener_span());
    TEST_ASSERT_TRUE(TcpListenerV.ok); // 0b1111110 -> 0b111110
    TEST_ASSERT_EQUAL(PROTOCORE_NET_OK, accept_on(0, &g_newpcb));
...
void test_the_global_throttle_spends_and_refills_its_window(void)
{
    ...
    TcpListenerV.gate.now_ms = PROTOCORE_ACCEPT_THROTTLE_WINDOW_MS;
    TcpListener.accept_allowed(protocore_tcp_listener_span());
    TEST_ASSERT_TRUE(TcpListenerV.ok);
}
...
void test_the_global_throttle_survives_the_counter_wrap(void)
{
    ...
    TcpListener.accept_allowed(protocore_tcp_listener_span());
    TEST_ASSERT_FALSE(TcpListenerV.ok);
    TcpListenerV.gate.now_ms = late + PROTOCORE_ACCEPT_THROTTLE_WINDOW_MS;
    TcpListener.accept_allowed(protocore_tcp_listener_span());
    TEST_ASSERT_TRUE(TcpListenerV.ok);
}
...
void test_each_address_has_its_own_budget(void)
{
    ...
    TcpListenerV.gate.now_ms = 0;
    TcpListener.accept_allowed_ip(protocore_tcp_listener_span());
    TEST_ASSERT_FALSE(TcpListenerV.ok); // a is spent
    TcpListenerV.gate.addr = &b;
    TcpListenerV.gate.now_ms = 0;
    TcpListener.accept_allowed_ip(protocore_tcp_listener_span());
    TEST_ASSERT_TRUE(TcpListenerV.ok); // b is not
}
...
void test_an_address_family_does_not_share_a_bucket(void)
{
    ...
    TcpListener.accept_allowed_ip(protocore_tcp_listener_span());
    TEST_ASSERT_FALSE(TcpListenerV.ok);
    TcpListenerV.gate.addr = &v6a;
    TcpListenerV.gate.now_ms = 0;
    TcpListener.accept_allowed_ip(protocore_tcp_listener_span());
    TEST_ASSERT_TRUE(TcpListenerV.ok); // its own bucket
}
...
void test_the_bucket_table_is_bounded_and_evicts(void)
{
    for (int i = 0; i < PROTOCORE_PER_IP_THROTTLE_SLOTS + 4; i++)
    {
        ...
        TcpListenerV.gate.now_ms = (uint32_t)i;
        TcpListener.accept_allowed_ip(protocore_tcp_listener_span());
        TEST_ASSERT_TRUE(TcpListenerV.ok);
    }
}
...
void test_a_per_address_window_refills(void)
{
    ...
    TEST_ASSERT_FALSE(TcpListenerV.ok);
    TcpListenerV.gate.addr = &a;
    TcpListenerV.gate.now_ms = PROTOCORE_PER_IP_THROTTLE_WINDOW_MS;
    TcpListener.accept_allowed_ip(protocore_tcp_listener_span());
    TEST_ASSERT_TRUE(TcpListenerV.ok);
}
...
void test_a_prefix_matches_on_its_network_bits_alone(void)
{
    ...
    TcpListenerV.gate.addr = &inside;
    TcpListener.ip_allowed(protocore_tcp_listener_span());
    TEST_ASSERT_TRUE(TcpListenerV.ok);
    TcpListenerV.gate.addr = &outside;
    TcpListener.ip_allowed(protocore_tcp_listener_span());
    TEST_ASSERT_FALSE(TcpListenerV.ok);
}
...
void test_a_zero_length_prefix_matches_every_address(void)
{
    ...
    TcpListenerV.gate.addr = &anything;
    TcpListener.ip_allowed(protocore_tcp_listener_span());
    TEST_ASSERT_TRUE(TcpListenerV.ok);
}
...
void test_a_full_length_prefix_matches_one_host(void)
{
    ...
    TcpListenerV.gate.addr = &neighbour;
    TcpListener.ip_allowed(protocore_tcp_listener_span());
    TEST_ASSERT_FALSE(TcpListenerV.ok);
}
...
void test_a_rule_never_matches_across_families(void)
{
    ...
    TcpListenerV.gate.prefix_len = 0;
    TcpListener.ip_allow_add(protocore_tcp_listener_span());
    TEST_ASSERT_TRUE(TcpListenerV.ok); // "everything", in v4
...
void test_any_matching_rule_admits_the_address(void)
{
    ...
    TEST_ASSERT_TRUE(TcpListenerV.ok);
    TcpListenerV.gate.addr = &b;
    TcpListenerV.gate.prefix_len = 16;
    TcpListener.ip_allow_add(protocore_tcp_listener_span());
    TEST_ASSERT_TRUE(TcpListenerV.ok);
    ...
    TcpListenerV.gate.addr = &in_a;
    TcpListener.ip_allowed(protocore_tcp_listener_span());
    TEST_ASSERT_TRUE(TcpListenerV.ok);
    TcpListenerV.gate.addr = &in_b;
    TcpListener.ip_allowed(protocore_tcp_listener_span());
    TEST_ASSERT_TRUE(TcpListenerV.ok);
    TcpListenerV.gate.addr = &in_neither;
    TcpListener.ip_allowed(protocore_tcp_listener_span());
    TEST_ASSERT_FALSE(TcpListenerV.ok);
}
...
{
    TcpListenerV.gate.cidr = "10.0.0.0/8";
...
{
    TcpListenerV.gate.cidr = "172.16.3.4";
    TcpListener.ip_allow_add_cidr(protocore_tcp_listener_span());
    TEST_ASSERT_TRUE(TcpListenerV.ok);
    protocore_ip exact = v4(172, 16, 3, 4);
    protocore_ip near = v4(172, 16, 3, 5);
    TcpListenerV.gate.addr = &exact;
    TcpListener.ip_allowed(protocore_tcp_listener_span());
    TEST_ASSERT_TRUE(TcpListenerV.ok);
    TcpListenerV.gate.addr = &near;
    TcpListener.ip_allowed(protocore_tcp_listener_span());
    TEST_ASSERT_FALSE(TcpListenerV.ok);
}
...
void test_a_prefix_wider_than_the_family_is_rejected(void)
{
    ...
    TcpListener.ip_allow_add(protocore_tcp_listener_span());
    TEST_ASSERT_FALSE(TcpListenerV.ok);
    TcpListenerV.gate.cidr = "10.0.0.0/33";
    TcpListener.ip_allow_add_cidr(protocore_tcp_listener_span());
    TEST_ASSERT_FALSE(TcpListenerV.ok);
    TcpListenerV.gate.cidr = "10.0.0.0/999";
    TcpListener.ip_allow_add_cidr(protocore_tcp_listener_span());
    TEST_ASSERT_FALSE(TcpListenerV.ok);
}
...
{
    TcpListenerV.gate.addr = NULL;
    TcpListenerV.gate.prefix_len = 8;
    TcpListener.ip_allow_add(protocore_tcp_listener_span());
    TEST_ASSERT_FALSE(TcpListenerV.ok);
    TcpListenerV.gate.cidr = NULL;
    TcpListener.ip_allow_add_cidr(protocore_tcp_listener_span());
    TEST_ASSERT_FALSE(TcpListenerV.ok);
    TcpListenerV.gate.cidr = "10.0.0.0/";
    TcpListener.ip_allow_add_cidr(protocore_tcp_listener_span());
    TEST_ASSERT_FALSE(TcpListenerV.ok); // no prefix digits
    TcpListenerV.gate.cidr = "10.0.0.0/8x";
    TcpListener.ip_allow_add_cidr(protocore_tcp_listener_span());
    TEST_ASSERT_FALSE(TcpListenerV.ok); // not a number
    TcpListenerV.gate.cidr = "not-an-address/8";
    TcpListener.ip_allow_add_cidr(protocore_tcp_listener_span());
    TEST_ASSERT_FALSE(TcpListenerV.ok);
    ...
    TcpListenerV.gate.prefix_len = 0;
    TcpListener.ip_allow_add(protocore_tcp_listener_span());
    TEST_ASSERT_FALSE(TcpListenerV.ok); // no family to size a prefix against
}
...
{
    TcpListenerV.idx = MAX_LISTENERS;
    TcpListenerV.bind.port = 80;
    TcpListenerV.bind.proto = PROTO_HTTP;
    TcpListenerV.bind.tls = PROTO_FALSE;
    TcpListener.add(protocore_tcp_listener_span());
...
{
    TcpListenerV.idx = 0;
    TcpListenerV.q.evt = NULL;
    TcpListener.enqueue(protocore_tcp_listener_span());
    TEST_ASSERT_FALSE(TcpListenerV.ok);
    TcpEvt bad = {EVT_DATA, (uint8_t)CONN_POOL_SLOTS, 0};
    TcpListenerV.idx = 0;
    TcpListenerV.q.evt = &bad;
    TcpListener.enqueue(protocore_tcp_listener_span());
    TEST_ASSERT_FALSE(TcpListenerV.ok);
}
...
void test_enqueue_reports_a_full_queue(void)
{
    ...
    TcpListenerV.q.evt = &evt;
    TcpListener.enqueue(protocore_tcp_listener_span());
    TEST_ASSERT_TRUE(TcpListenerV.ok); // the latch was one-shot
}
