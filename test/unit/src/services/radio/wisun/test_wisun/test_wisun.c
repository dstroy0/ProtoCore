...
void test_rfc7252_figure_16_request(void)
{
    static const uint8_t WANT[16] = {0x40, 0x01, 0x7D, 0x34, 0xBB, 't', 'e', 'm',
                                     'p',  'e',  'r',  'a',  't',  'u', 'r', 'e'};
    uint8_t out[64];
    WisunV.build_coap_args.type = WISUN_COAP_CON;
    WisunV.build_coap_args.code = WISUN_COAP_GET;
    WisunV.build_coap_args.msg_id = 0x7d34;
    WisunV.build_coap_args.token = NULL;
    WisunV.build_coap_args.tkl = 0;
    WisunV.build_coap_args.uri_path = "temperature";
    WisunV.build_coap_args.payload = NULL;
    WisunV.build_coap_args.plen = 0;
    WisunV.build_coap_args.out = out;
    WisunV.build_coap_args.cap = sizeof(out);
    Wisun.build_coap(wisun_work);
    const size_t n = WisunV.n;
...
void test_leading_slash_is_not_a_segment(void)
{
    ...
    WisunV.build_coap_args.payload = NULL;
    WisunV.build_coap_args.plen = 0;
    WisunV.build_coap_args.out = with;
    WisunV.build_coap_args.cap = sizeof(with);
    Wisun.build_coap(wisun_work);
    const size_t a = WisunV.n;
    WisunV.build_coap_args.type = WISUN_COAP_CON;
    WisunV.build_coap_args.code = WISUN_COAP_GET;
    WisunV.build_coap_args.msg_id = 0x7d34;
    WisunV.build_coap_args.token = NULL;
    ...
    WisunV.build_coap_args.payload = NULL;
    WisunV.build_coap_args.plen = 0;
    WisunV.build_coap_args.out = without;
    WisunV.build_coap_args.cap = sizeof(without);
    Wisun.build_coap(wisun_work);
    const size_t b = WisunV.n;
...
void test_type_field_selects_confirmable_or_not(void)
{
    ...
    WisunV.build_coap_args.type = WISUN_COAP_CON;
    WisunV.build_coap_args.code = WISUN_COAP_GET;
    WisunV.build_coap_args.msg_id = 1;
    WisunV.build_coap_args.token = NULL;
    WisunV.build_coap_args.tkl = 0;
    WisunV.build_coap_args.uri_path = NULL;
    WisunV.build_coap_args.payload = NULL;
    WisunV.build_coap_args.plen = 0;
    WisunV.build_coap_args.out = out;
    WisunV.build_coap_args.cap = sizeof(out);
    Wisun.build_coap(wisun_work);
    TEST_ASSERT_EQUAL_size_t(4, WisunV.n);
    TEST_ASSERT_EQUAL_HEX8(0x40, out[0]);
    WisunV.build_coap_args.type = WISUN_COAP_NON;
    WisunV.build_coap_args.code = WISUN_COAP_GET;
    WisunV.build_coap_args.msg_id = 1;
    WisunV.build_coap_args.token = NULL;
    WisunV.build_coap_args.tkl = 0;
    ...
    WisunV.build_coap_args.type = WISUN_COAP_CON;
    WisunV.build_coap_args.code = WISUN_COAP_PUT;
    WisunV.build_coap_args.msg_id = 0xABCD;
    WisunV.build_coap_args.token = NULL;
    WisunV.build_coap_args.tkl = 0;
    WisunV.build_coap_args.uri_path = NULL;
    WisunV.build_coap_args.payload = NULL;
...
void test_token_length_and_placement(void)
{
    ...
    WisunV.build_coap_args.type = WISUN_COAP_CON;
    WisunV.build_coap_args.code = WISUN_COAP_GET;
    WisunV.build_coap_args.msg_id = 0x0001;
    WisunV.build_coap_args.token = TOKEN;
    WisunV.build_coap_args.tkl = sizeof(TOKEN);
    WisunV.build_coap_args.uri_path = "temp";
    WisunV.build_coap_args.payload = NULL;
    WisunV.build_coap_args.plen = 0;
    WisunV.build_coap_args.out = out;
    WisunV.build_coap_args.cap = sizeof(out);
    ...
    for (uint8_t tkl = 9; tkl < 16; tkl++)
    {
        ...
        WisunV.build_coap_args.code = WISUN_COAP_GET;
        WisunV.build_coap_args.msg_id = 1;
        WisunV.build_coap_args.token = big;
        WisunV.build_coap_args.tkl = tkl;
        WisunV.build_coap_args.uri_path = "a";
        WisunV.build_coap_args.payload = NULL;
        WisunV.build_coap_args.plen = 0;
        WisunV.build_coap_args.out = out;
        WisunV.build_coap_args.cap = sizeof(out);
        Wisun.build_coap(wisun_work);
        TEST_ASSERT_EQUAL_size_t(0, WisunV.n);
    }
...
void test_each_path_segment_is_its_own_option(void)
{
    ...
    WisunV.build_coap_args.type = WISUN_COAP_CON;
    WisunV.build_coap_args.code = WISUN_COAP_GET;
    WisunV.build_coap_args.msg_id = 42;
    WisunV.build_coap_args.token = NULL;
    WisunV.build_coap_args.tkl = 0;
    WisunV.build_coap_args.uri_path = "sensors/temp";
    WisunV.build_coap_args.payload = NULL;
    WisunV.build_coap_args.plen = 0;
    WisunV.build_coap_args.out = out;
    WisunV.build_coap_args.cap = sizeof(out);
    ...
    WisunV.build_coap_args.token = NULL;
    WisunV.build_coap_args.tkl = 0;
    WisunV.build_coap_args.uri_path = "a/b/c";
    WisunV.build_coap_args.payload = NULL;
    WisunV.build_coap_args.plen = 0;
    WisunV.build_coap_args.out = out;
    WisunV.build_coap_args.cap = sizeof(out);
    Wisun.build_coap(wisun_work);
    const size_t m = WisunV.n;
...
void test_option_length_extension(void)
{
    ...
    WisunV.build_coap_args.token = NULL;
    WisunV.build_coap_args.tkl = 0;
    WisunV.build_coap_args.uri_path = SEG12;
    WisunV.build_coap_args.payload = NULL;
    WisunV.build_coap_args.plen = 0;
    WisunV.build_coap_args.out = out;
    WisunV.build_coap_args.cap = sizeof(out);
    ...
    WisunV.build_coap_args.token = NULL;
    WisunV.build_coap_args.tkl = 0;
    WisunV.build_coap_args.uri_path = SEG13;
    WisunV.build_coap_args.payload = NULL;
    WisunV.build_coap_args.plen = 0;
    WisunV.build_coap_args.out = out;
    WisunV.build_coap_args.cap = sizeof(out);
    ...
    WisunV.build_coap_args.token = NULL;
    WisunV.build_coap_args.tkl = 0;
    WisunV.build_coap_args.uri_path = SEG20;
    WisunV.build_coap_args.payload = NULL;
    WisunV.build_coap_args.plen = 0;
    WisunV.build_coap_args.out = out;
    WisunV.build_coap_args.cap = sizeof(out);
...
void test_payload_marker(void)
{
    ...
    WisunV.build_coap_args.tkl = 0;
    WisunV.build_coap_args.uri_path = "temp";
    WisunV.build_coap_args.payload = BODY;
    WisunV.build_coap_args.plen = sizeof(BODY);
    WisunV.build_coap_args.out = out;
    WisunV.build_coap_args.cap = sizeof(out);
    Wisun.build_coap(wisun_work);
    const size_t n = WisunV.n;
...
void test_build_refuses_a_short_buffer(void)
{
    ...
    for (size_t cap = 0; cap < exact; cap++)
    {
        ...
        WisunV.build_coap_args.plen = 0;
        WisunV.build_coap_args.out = out;
        WisunV.build_coap_args.cap = cap;
        Wisun.build_coap(wisun_work);
        TEST_ASSERT_EQUAL_size_t(0, WisunV.n);
    }
    WisunV.build_coap_args.type = WISUN_COAP_CON;
    ...
    WisunV.build_coap_args.plen = 0;
    WisunV.build_coap_args.out = out;
    WisunV.build_coap_args.cap = exact;
    Wisun.build_coap(wisun_work);
    TEST_ASSERT_EQUAL_size_t(exact, WisunV.n);
    WisunV.build_coap_args.type = WISUN_COAP_CON;
    WisunV.build_coap_args.code = WISUN_COAP_GET;
    WisunV.build_coap_args.msg_id = 1;
    WisunV.build_coap_args.token = NULL;
    ...
    WisunV.build_coap_args.payload = NULL;
    WisunV.build_coap_args.plen = 0;
    WisunV.build_coap_args.out = NULL;
    WisunV.build_coap_args.cap = 32;
    Wisun.build_coap(wisun_work);
    TEST_ASSERT_EQUAL_size_t(0, WisunV.n);
}
...
void test_node_registry(void)
{
    ...
    WisunV.node_register_args.addr = &a;
    WisunV.node_register_args.now = 100;
    Wisun.node_register(wisun_work);
    TEST_ASSERT_EQUAL_INT(0, WisunV.i32);
    WisunV.node_register_args.fan = &fan;
    WisunV.node_register_args.addr = &b;
    WisunV.node_register_args.now = 200;
    Wisun.node_register(wisun_work);
    TEST_ASSERT_EQUAL_INT(1, WisunV.i32);
    TEST_ASSERT_EQUAL_size_t(2, fan.count);

    // The same address again is the same entry, with a fresh last_seen.
    WisunV.node_register_args.fan = &fan;
    WisunV.node_register_args.addr = &a;
    WisunV.node_register_args.now = 300;
    Wisun.node_register(wisun_work);
    TEST_ASSERT_EQUAL_INT(0, WisunV.i32);
    TEST_ASSERT_EQUAL_size_t(2, fan.count);
    ...
    WisunV.node_find_args.addr = &b;
    WisunV.node_find_args.idx = &idx;
    Wisun.node_find(wisun_work);
    TEST_ASSERT_TRUE(WisunV.ok);
    TEST_ASSERT_EQUAL_size_t(1, idx);
    WisunV.node_find_args.fan = &fan;
    WisunV.node_find_args.addr = &c;
    WisunV.node_find_args.idx = &idx;
    Wisun.node_find(wisun_work);
    TEST_ASSERT_FALSE(WisunV.ok);
    TEST_ASSERT_EQUAL_size_t(1, idx); // untouched on a miss

    WisunV.node_register_args.fan = &fan;
    WisunV.node_register_args.addr = &c;
    WisunV.node_register_args.now = 400;
    Wisun.node_register(wisun_work);
    TEST_ASSERT_EQUAL_INT(2, WisunV.i32);
    WisunV.joined_count_args.fan = &fan;
    Wisun.joined_count(wisun_work);
    TEST_ASSERT_EQUAL_size_t(3, WisunV.n);
    WisunV.node_register_args.fan = &fan;
    WisunV.node_register_args.addr = &d;
    WisunV.node_register_args.now = 500;
    Wisun.node_register(wisun_work);
    TEST_ASSERT_EQUAL_INT(-1, WisunV.i32); // full
    ...
    WisunV.node_find_args.fan = &fan;
    WisunV.node_find_args.addr = &br;
    WisunV.node_find_args.idx = NULL;
    Wisun.node_find(wisun_work);
    TEST_ASSERT_FALSE(WisunV.ok);
}
...
void test_registry_without_storage(void)
{
    ...
    WisunV.node_register_args.fan = &fan;
    WisunV.node_register_args.addr = &a;
    WisunV.node_register_args.now = 1;
    Wisun.node_register(wisun_work);
    TEST_ASSERT_EQUAL_INT(-1, WisunV.i32);
    WisunV.node_find_args.fan = &fan;
    WisunV.node_find_args.addr = &a;
    WisunV.node_find_args.idx = NULL;
    Wisun.node_find(wisun_work);
    TEST_ASSERT_FALSE(WisunV.ok);
    WisunV.joined_count_args.fan = &fan;
    ...
    WisunNode storage[1];
    WisunV.init_args.fan = &fan;
    WisunV.init_args.border_router = NULL;
    WisunV.init_args.storage = storage;
    WisunV.init_args.cap = 1;
    Wisun.init(wisun_work);
    IpV.args.ip = &fan.border_router;
    Ip.is_unspecified(ip_work);
    TEST_ASSERT_TRUE(IpV.ok);

    WisunV.init_args.fan = NULL;
    WisunV.init_args.border_router = &br;
    WisunV.init_args.storage = storage;
    WisunV.init_args.cap = 1;
    Wisun.init(wisun_work); // no state to write, no crash
    WisunV.node_register_args.fan = &fan;
    WisunV.node_register_args.addr = NULL;
    WisunV.node_register_args.now = 1;
    Wisun.node_register(wisun_work);
    TEST_ASSERT_EQUAL_INT(-1, WisunV.i32);
    WisunV.node_register_args.fan = NULL;
    WisunV.node_register_args.addr = &a;
    WisunV.node_register_args.now = 1;
    Wisun.node_register(wisun_work);
    TEST_ASSERT_EQUAL_INT(-1, WisunV.i32);
    WisunV.node_find_args.fan = NULL;
    WisunV.node_find_args.addr = &a;
    WisunV.node_find_args.idx = NULL;
    Wisun.node_find(wisun_work);
    TEST_ASSERT_FALSE(WisunV.ok);
    WisunV.joined_count_args.fan = NULL;
    Wisun.joined_count(wisun_work);
    TEST_ASSERT_EQUAL_size_t(0, WisunV.n);
}
...
void test_nodes_json(void)
{
    ...
    WisunV.init_args.border_router = &br;
    WisunV.init_args.storage = storage;
    WisunV.init_args.cap = 2;
    Wisun.init(wisun_work);

    char out[128];
    WisunV.nodes_json_args.fan = &fan;
    WisunV.nodes_json_args.out = out;
    WisunV.nodes_json_args.cap = sizeof(out);
    Wisun.nodes_json(wisun_work);
    TEST_ASSERT_EQUAL_size_t(2, WisunV.n);
    ...
    WisunV.node_register_args.fan = &fan;
    WisunV.node_register_args.addr = &b;
    WisunV.node_register_args.now = 2;
    Wisun.node_register(wisun_work);
    TEST_ASSERT_EQUAL_INT(1, WisunV.i32);
    ...
    for (size_t cap = 1; cap <= n; cap++)
    {
        ...
        WisunV.nodes_json_args.fan = &fan;
        WisunV.nodes_json_args.out = small;
        WisunV.nodes_json_args.cap = cap;
        Wisun.nodes_json(wisun_work);
        TEST_ASSERT_EQUAL_size_t(0, WisunV.n);
    }
    WisunV.nodes_json_args.fan = &fan;
    WisunV.nodes_json_args.out = out;
    WisunV.nodes_json_args.cap = 0;
    Wisun.nodes_json(wisun_work);
    TEST_ASSERT_EQUAL_size_t(0, WisunV.n);
    WisunV.nodes_json_args.fan = NULL;
    WisunV.nodes_json_args.out = out;
    WisunV.nodes_json_args.cap = sizeof(out);
    Wisun.nodes_json(wisun_work);
    TEST_ASSERT_EQUAL_size_t(0, WisunV.n);
    WisunV.nodes_json_args.fan = &fan;
    WisunV.nodes_json_args.out = NULL;
    WisunV.nodes_json_args.cap = sizeof(out);
    Wisun.nodes_json(wisun_work);
    TEST_ASSERT_EQUAL_size_t(0, WisunV.n);
}
