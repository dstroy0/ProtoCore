...
void test_spinel_value_wire_layout(void)
{
    ...
    ThreadV.spinel_reader_init(thread_work);
    uint16_t u16 = 0;
    uint32_t u32 = 0;
    int8_t i8 = 0;
    int16_t i16 = 0;
...
void test_spinel_cursor_bounds_latch(void)
{
    ...
    ThreadV.spinel_get_u8(thread_work);
