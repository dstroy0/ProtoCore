...
static size_t build_streams(void)
{
    ...
    MtConnectV.streams.component_id = "d1";
    MtConnectV.streams.device_uuid = "uuid-1";
    MtConnectV.window.buffer_size = PROTOCORE_MTC_SAMPLE_BUFFER;
    MtConnectV.window.first_seq = 1u;
    MtConnectV.window.last_seq = 0u;
    MtConnectV.doc.out = g_buf;
    MtConnectV.doc.cap = sizeof(g_buf);
    MtConnectV.doc.instance_id = 7;
    MtConnectV.streams.next_seq = 100;
    MtConnectV.streams.device_name = "VF2";
    MtConnect.streams_begin(protocore_mtconnect_span());
    MtConnectV.obs.cat = PROTOCORE_MTC_SAMPLE;
    MtConnectV.obs.type = "Position";
    MtConnectV.obs.data_id = "Xabs";
    MtConnectV.obs.seq = 1;
    MtConnectV.obs.timestamp = "2026-01-01T00:00:00Z";
    MtConnectV.obs.value = "1.5";
...
{
    MtConnectV.assets.asset_buffer_size = PROTOCORE_MTC_SAMPLE_BUFFER;
    MtConnectV.assets.asset_count = 0u;
    MtConnectV.doc.sender = "agent-1";
    MtConnectV.doc.out = g_buf;
    MtConnectV.doc.cap = sizeof(g_buf);
    MtConnectV.doc.instance_id = 7;
    MtConnectV.device.device_id = "d1";
    MtConnectV.device.device_name = "VF2";
    MtConnectV.device.uuid = "uuid-1";
    MtConnect.devices_begin(protocore_mtconnect_span());
    MtConnectV.item.cat = PROTOCORE_MTC_SAMPLE;
    MtConnectV.item.id = "Xabs";
    MtConnectV.item.type = "POSITION";
    MtConnectV.item.name = "Xpos";
    MtConnectV.item.units = "MILLIMETER";
...
static size_t build_assets(void)
{
    ...
    MtConnectV.doc.cap = sizeof(g_buf);
    MtConnectV.doc.instance_id = 7;
    MtConnectV.assets.asset_count = 1;
    MtConnectV.assets.asset_buffer_size = 64;
    MtConnect.assets_begin(protocore_mtconnect_span());
    MtConnectV.tool.asset_id = "T5";
    MtConnectV.tool.serial_number = "SN-9";
    MtConnectV.tool.tool_id = "5";
    MtConnectV.tool.device_uuid = "uuid-1";
    MtConnectV.tool.timestamp = "2026-01-01T00:00:00Z";
    ...
    MtConnectV.life.value = "37";
    MtConnect.tool_life(protocore_mtconnect_span());
    MtConnectV.life.type = "PART_COUNT";
    MtConnectV.life.count_direction = "UP";
    MtConnectV.life.initial = "0";
    MtConnectV.life.limit = "500";
    MtConnectV.life.value = "12";
    MtConnect.tool_life(protocore_mtconnect_span());
...
{
    MtConnectV.doc.sender = "agent-1";
    MtConnectV.doc.instance_id = 42;
    MtConnectV.err.error_code = "OUT_OF_RANGE";
    MtConnectV.err.message = "'from' must be <= 99";
    MtConnectV.doc.out = g_buf;
    MtConnectV.doc.cap = sizeof(g_buf);
...
void test_every_document_is_well_formed_xml(void)
{
    ...
    MtConnectV.streams.next_seq = 1000;
...
void test_the_component_stream_groups_each_category_once_and_in_order(void)
{
    ...
    MtConnectV.obs.seq = 2;
    MtConnectV.obs.timestamp = "2026-01-01T00:00:01Z";
    MtConnectV.obs.value = "ACTIVE";
    MtConnect.streams_add(protocore_mtconnect_span());
    MtConnectV.obs.cat = PROTOCORE_MTC_SAMPLE;
    MtConnectV.obs.type = "Position";
    MtConnectV.obs.data_id = "Xabs";
    MtConnectV.obs.seq = 3;
    MtConnectV.obs.timestamp = "2026-01-01T00:00:02Z";
    MtConnectV.obs.value = "2.5";
    MtConnect.streams_add(protocore_mtconnect_span());
    MtConnectV.obs.cat = PROTOCORE_MTC_CONDITION;
    MtConnectV.obs.type = "SYSTEM";
    MtConnectV.obs.data_id = "sys";
    MtConnectV.obs.seq = 4;
    MtConnectV.obs.timestamp = "2026-01-01T00:00:03Z";
    MtConnectV.obs.value = "Fault";
    MtConnect.streams_add(protocore_mtconnect_span());
    MtConnect.streams_end(protocore_mtconnect_span());
    TEST_ASSERT_TRUE(MtConnectV.n > 0);
...
void test_a_condition_is_one_of_the_four_published_states(void)
{
    ...
    for (size_t i = 0; i < sizeof(STATE) / sizeof(STATE[0]); i++)
    {
        ...
        MtConnectV.obs.type = "SYSTEM";
        MtConnectV.obs.data_id = "sys";
        MtConnectV.obs.seq = 5;
        MtConnectV.obs.timestamp = "2026-01-01T00:00:00Z";
        MtConnectV.obs.value = STATE[i];
        MtConnect.streams_add(protocore_mtconnect_span());
        MtConnect.streams_end(protocore_mtconnect_span());
        TEST_ASSERT_TRUE(MtConnectV.n > 0);
        TEST_ASSERT_TRUE(xml_wf(g_buf));
...
void test_a_data_item_carries_its_required_attributes_and_a_published_category(void)
{
    ...
    MtConnectV.item.units = "MILLIMETER";
    MtConnect.devices_add(protocore_mtconnect_span());
    MtConnectV.item.cat = PROTOCORE_MTC_EVENT;
    MtConnectV.item.id = "exec";
    MtConnectV.item.type = "EXECUTION";
    MtConnectV.item.name = NULL;
    MtConnectV.item.units = NULL;
    MtConnect.devices_add(protocore_mtconnect_span());
    MtConnectV.item.cat = PROTOCORE_MTC_CONDITION;
    MtConnectV.item.id = "sys";
    MtConnectV.item.type = "SYSTEM";
    MtConnectV.item.name = "";
    MtConnectV.item.units = "";
    MtConnect.devices_add(protocore_mtconnect_span());
    MtConnect.devices_end(protocore_mtconnect_span());
    TEST_ASSERT_TRUE(MtConnectV.n > 0);
    TEST_ASSERT_TRUE(xml_wf(g_buf));
...
void test_markup_characters_in_values_are_escaped(void)
{
    ...
    MtConnectV.doc.out = g_buf;
    MtConnectV.doc.cap = sizeof(g_buf);
    MtConnectV.doc.instance_id = 1;
    MtConnectV.streams.next_seq = 1;
    MtConnectV.streams.device_name = NAME;
    MtConnect.streams_begin(protocore_mtconnect_span());
    MtConnectV.obs.cat = PROTOCORE_MTC_EVENT;
    MtConnectV.obs.type = "Message";
    MtConnectV.obs.data_id = "msg";
    MtConnectV.obs.seq = 1;
    MtConnectV.obs.timestamp = "2026-01-01T00:00:00Z";
    MtConnectV.obs.value = VALUE;
    MtConnect.streams_add(protocore_mtconnect_span());
    MtConnect.streams_end(protocore_mtconnect_span());
    TEST_ASSERT_TRUE(MtConnectV.n > 0);
...
void test_overflow_reports_zero_length(void)
{
    ...
    MtConnectV.window.first_seq = 1u;
    MtConnectV.window.last_seq = 0u;
    MtConnectV.doc.out = small;
    MtConnectV.doc.cap = sizeof(small);
    MtConnectV.doc.instance_id = 1;
    MtConnectV.streams.next_seq = 1;
    MtConnectV.streams.device_name = "VF2";
    MtConnect.streams_begin(protocore_mtconnect_span());
    ...
    MtConnect.streams_end(protocore_mtconnect_span());
    TEST_ASSERT_EQUAL_size_t(0u, MtConnectV.n);
    ...
    MtConnectV.window.first_seq = 1u;
    MtConnectV.window.last_seq = 0u;
    MtConnectV.doc.out = NULL;
    MtConnectV.doc.cap = 1024;
    MtConnectV.doc.instance_id = 1;
    MtConnectV.streams.next_seq = 1;
    MtConnectV.streams.device_name = "VF2";
    MtConnect.streams_begin(protocore_mtconnect_span());
    ...
    MtConnectV.doc.instance_id = 42;
    MtConnectV.err.error_code = "OUT_OF_RANGE";
    MtConnectV.err.message = "x";
    MtConnectV.doc.out = small;
    MtConnectV.doc.cap = 8;
    MtConnect.error(protocore_mtconnect_span());
    TEST_ASSERT_EQUAL_size_t(0u, MtConnectV.n);
    MtConnectV.doc.sender = "agent-1";
    MtConnectV.doc.instance_id = 42;
...
void test_sample_buffer_assigns_monotonic_sequences(void)
{
    ...
    for (uint32_t i = 0; i < 3; i++)
    {
        ...
        MtConnectV.obs.value = "1.5";
        MtConnect.ring_add(protocore_mtconnect_span());
        const uint64_t seq = MtConnectV.seq;
...
void test_sample_buffer_eviction_advances_the_window(void)
{
    ...
    TEST_ASSERT_EQUAL_UINT64((uint64_t)(1000 + PROTOCORE_MTC_SAMPLE_BUFFER + 1),
                             MTC_CTX(protocore_mtconnect_span())->next_seq);
    TEST_ASSERT_EQUAL_UINT64((uint64_t)MTC_CTX(protocore_mtconnect_span())->count,
                             MTC_CTX(protocore_mtconnect_span())->next_seq -
                                 MTC_CTX(protocore_mtconnect_span())->first_seq);
}
...
void test_sample_query_replays_the_requested_window(void)
{
    ...
    MtConnectV.doc.instance_id = 7;
    MtConnectV.streams.device_name = "VF2";
    MtConnectV.query.from = 1001;
    MtConnectV.query.count = 1;
    MtConnect.ring_query(protocore_mtconnect_span());
    TEST_ASSERT_TRUE(MtConnectV.n > 0);
...
void test_sample_query_clamps_a_stale_from(void)
{
    ...
    MtConnectV.doc.instance_id = 7;
    MtConnectV.streams.device_name = "VF2";
    MtConnectV.query.from = 0;
    MtConnectV.query.count = 2;
    MtConnect.ring_query(protocore_mtconnect_span());
    TEST_ASSERT_TRUE(MtConnectV.n > 0);
