...
{
    CanFrame req;
    CanopenV.build_sdo_read_args.out = &req;
    CanopenV.build_sdo_read_args.node_id = 5;
    CanopenV.build_sdo_read_args.index = 0x1018u;
    CanopenV.build_sdo_read_args.sub = 1;
    ...
    CanopenV.parse_sdo_response_args.f = &resp;
    CanopenV.parse_sdo_response_args.out = &out;
...
void test_sdo_expedited_download_encodes_the_unused_octet_count(void)
{
    ...
    for (size_t i = 0; i < sizeof(CASES) / sizeof(CASES[0]); i++)
    {
        ...
        CanopenV.build_sdo_write_args.node_id = 0x7F;
        CanopenV.build_sdo_write_args.index = 0x6040u;
        CanopenV.build_sdo_write_args.sub = 0;
        CanopenV.build_sdo_write_args.data = DATA;
        CanopenV.build_sdo_write_args.len = CASES[i].len;
    ...
    CanFrame f;
    CanopenV.build_sdo_write_args.out = &f;
    CanopenV.build_sdo_write_args.node_id = 1;
    CanopenV.build_sdo_write_args.index = 0x1000u;
    CanopenV.build_sdo_write_args.sub = 0;
    CanopenV.build_sdo_write_args.data = DATA;
    CanopenV.build_sdo_write_args.len = 0;
    Canopen.build_sdo_write(canopen_work);
    TEST_ASSERT_FALSE(CanopenV.ok); // expedited carries 1..4
    CanopenV.build_sdo_write_args.out = &f;
    CanopenV.build_sdo_write_args.node_id = 1;
    CanopenV.build_sdo_write_args.index = 0x1000u;
    CanopenV.build_sdo_write_args.sub = 0;
    CanopenV.build_sdo_write_args.data = DATA;
    CanopenV.build_sdo_write_args.len = 5;
    Canopen.build_sdo_write(canopen_work);
    TEST_ASSERT_FALSE(CanopenV.ok);
    CanopenV.build_sdo_write_args.out = &f;
    CanopenV.build_sdo_write_args.node_id = 1;
    CanopenV.build_sdo_write_args.index = 0x1000u;
    CanopenV.build_sdo_write_args.sub = 0;
    CanopenV.build_sdo_write_args.data = NULL;
    CanopenV.build_sdo_write_args.len = 2;
    Canopen.build_sdo_write(canopen_work);
    TEST_ASSERT_FALSE(CanopenV.ok);
    CanopenV.build_sdo_read_args.out = &f;
    CanopenV.build_sdo_read_args.node_id = 0;
    CanopenV.build_sdo_read_args.index = 0x1000u;
    CanopenV.build_sdo_read_args.sub = 0;
    Canopen.build_sdo_read(canopen_work);
    TEST_ASSERT_FALSE(CanopenV.ok); // node 0 is not an SDO server
    CanopenV.build_sdo_read_args.out = &f;
    CanopenV.build_sdo_read_args.node_id = 128;
    CanopenV.build_sdo_read_args.index = 0x1000u;
    CanopenV.build_sdo_read_args.sub = 0;
    Canopen.build_sdo_read(canopen_work);
    TEST_ASSERT_FALSE(CanopenV.ok); // node ids are 1..127
}
...
{
    CanFrame f;
    CanopenV.build_sdo_abort_args.out = &f;
    CanopenV.build_sdo_abort_args.node_id = 3;
    CanopenV.build_sdo_abort_args.index = 0x1018u;
    CanopenV.build_sdo_abort_args.sub = 9;
    CanopenV.build_sdo_abort_args.abort_code = CANOPEN_ABORT_NO_SUBINDEX;
    ...
    CanopenV.build_sdo_abort_args.to_server = PROTO_TRUE;
    Canopen.build_sdo_abort(canopen_work);
    TEST_ASSERT_TRUE(CanopenV.ok);
...
{
    CanFrame f;
    CanopenV.build_nmt_args.out = &f;
    CanopenV.build_nmt_args.command = CANOPEN_NMT_START;
    CanopenV.build_nmt_args.node_id = 0;
    ...
    CanopenV.build_nmt_args.out = &f;
    CanopenV.build_nmt_args.command = CANOPEN_NMT_RESET_COMM;
    CanopenV.build_nmt_args.node_id = 42;
    Canopen.build_nmt(canopen_work);
    TEST_ASSERT_TRUE(CanopenV.ok);
    ...
    CanopenV.build_nmt_args.out = &f;
    CanopenV.build_nmt_args.command = CANOPEN_NMT_START;
    CanopenV.build_nmt_args.node_id = 128;
    Canopen.build_nmt(canopen_work);
    TEST_ASSERT_FALSE(CanopenV.ok);
    CanopenV.build_nmt_args.out = NULL;
    CanopenV.build_nmt_args.command = CANOPEN_NMT_START;
    CanopenV.build_nmt_args.node_id = 1;
    Canopen.build_nmt(canopen_work);
    TEST_ASSERT_FALSE(CanopenV.ok);

    CanopenMsg m;
    CanopenV.parse_args.f = &f;
    CanopenV.parse_args.out = &m;
...
{
    CanFrame sync;
    CanopenV.build_sync_args.out = &sync;
    ...
    CanopenV.build_emcy_args.out = &emcy;
    CanopenV.build_emcy_args.node_id = 4;
    CanopenV.build_emcy_args.error_code = 0x8130u;
    ...
    CanopenV.parse_emcy_args.f = &sync;
    CanopenV.parse_emcy_args.node_id = &node;
    CanopenV.parse_emcy_args.error_code = &code;
    CanopenV.parse_emcy_args.error_reg = &reg;
    CanopenV.parse_emcy_args.msef = got;
    ...
    TEST_ASSERT_FALSE(CanopenV.ok);
    CanopenV.build_emcy_args.out = &emcy;
    CanopenV.build_emcy_args.node_id = 0;
    CanopenV.build_emcy_args.error_code = 0;
    CanopenV.build_emcy_args.error_reg = 0;
    CanopenV.build_emcy_args.msef = MSEF;
    Canopen.build_emcy(canopen_work);
    TEST_ASSERT_FALSE(CanopenV.ok);
}
...
void test_heartbeat_state_and_toggle_bit(void)
{
    ...
    CanopenV.build_heartbeat_args.node_id = 0x7F;
    ...
    CanopenV.parse_heartbeat_args.f = &f;
    CanopenV.parse_heartbeat_args.node_id = &node;
    CanopenV.parse_heartbeat_args.state = &state;
    ...
    CanopenV.build_heartbeat_args.out = &f;
    CanopenV.build_heartbeat_args.node_id = 1;
    CanopenV.build_heartbeat_args.state = CANOPEN_STATE_BOOTUP;
    Canopen.build_heartbeat(canopen_work);
    TEST_ASSERT_TRUE(CanopenV.ok);
    CanopenV.parse_heartbeat_args.f = &f;
    CanopenV.parse_heartbeat_args.node_id = &node;
    ...
    CanopenV.build_heartbeat_args.out = &f;
    CanopenV.build_heartbeat_args.node_id = 0;
    CanopenV.build_heartbeat_args.state = CANOPEN_STATE_OPERATIONAL;
    Canopen.build_heartbeat(canopen_work);
    TEST_ASSERT_FALSE(CanopenV.ok);
    CanopenV.build_heartbeat_args.out = &f;
    CanopenV.build_heartbeat_args.node_id = 128;
    CanopenV.build_heartbeat_args.state = CANOPEN_STATE_OPERATIONAL;
    Canopen.build_heartbeat(canopen_work);
    TEST_ASSERT_FALSE(CanopenV.ok);
    ...
    CanopenV.parse_heartbeat_args.f = &other;
    CanopenV.parse_heartbeat_args.node_id = &node;
    CanopenV.parse_heartbeat_args.state = &state;
    Canopen.parse_heartbeat(canopen_work);
    TEST_ASSERT_FALSE(CanopenV.ok);
...
{
    CanFrame f;
    CanopenV.build_time_args.out = &f;
    CanopenV.build_time_args.ms_since_midnight = 86399999u;
    CanopenV.build_time_args.days_since_1984 = 5844u;
    ...
    CanopenTime t;
    CanopenV.parse_time_args.f = &f;
    CanopenV.parse_time_args.out = &t;
    ...
    CanopenV.build_time_args.out = &f;
    CanopenV.build_time_args.ms_since_midnight = 0xF0000001u;
    CanopenV.build_time_args.days_since_1984 = 1;
    Canopen.build_time(canopen_work);
    TEST_ASSERT_TRUE(CanopenV.ok);
...
void test_pdo_bases_and_classification(void)
{
    ...
    for (uint8_t n = 1; n <= 4; n++)
    {
        CanFrame f;
        CanopenMsg m;
        CanopenV.build_tpdo_args.out = &f;
        CanopenV.build_tpdo_args.pdo_num = n;
        CanopenV.build_tpdo_args.node_id = 9;
        CanopenV.build_tpdo_args.data = DATA;
        CanopenV.build_tpdo_args.len = 8;
        ...
        CanopenV.build_rpdo_args.out = &f;
        CanopenV.build_rpdo_args.pdo_num = n;
        CanopenV.build_rpdo_args.node_id = 9;
        CanopenV.build_rpdo_args.data = DATA;
        CanopenV.build_rpdo_args.len = 2;
    ...
    CanFrame f;
    CanopenV.build_tpdo_args.out = &f;
    CanopenV.build_tpdo_args.pdo_num = 0;
    CanopenV.build_tpdo_args.node_id = 9;
    CanopenV.build_tpdo_args.data = DATA;
    CanopenV.build_tpdo_args.len = 8;
    Canopen.build_tpdo(canopen_work);
    TEST_ASSERT_FALSE(CanopenV.ok); // PDO numbers are 1..4
    CanopenV.build_tpdo_args.out = &f;
    CanopenV.build_tpdo_args.pdo_num = 5;
    CanopenV.build_tpdo_args.node_id = 9;
    CanopenV.build_tpdo_args.data = DATA;
    CanopenV.build_tpdo_args.len = 8;
    Canopen.build_tpdo(canopen_work);
    TEST_ASSERT_FALSE(CanopenV.ok);
    CanopenV.build_tpdo_args.out = &f;
    CanopenV.build_tpdo_args.pdo_num = 1;
    CanopenV.build_tpdo_args.node_id = 9;
    CanopenV.build_tpdo_args.data = DATA;
    CanopenV.build_tpdo_args.len = 9;
    Canopen.build_tpdo(canopen_work);
    TEST_ASSERT_FALSE(CanopenV.ok); // classic CAN carries 8
    CanopenV.build_rpdo_args.out = &f;
    CanopenV.build_rpdo_args.pdo_num = 1;
    CanopenV.build_rpdo_args.node_id = 0;
    CanopenV.build_rpdo_args.data = DATA;
    CanopenV.build_rpdo_args.len = 8;
    Canopen.build_rpdo(canopen_work);
    TEST_ASSERT_FALSE(CanopenV.ok);
    CanopenV.build_rpdo_args.out = &f;
    CanopenV.build_rpdo_args.pdo_num = 1;
    CanopenV.build_rpdo_args.node_id = 9;
    CanopenV.build_rpdo_args.data = NULL;
    CanopenV.build_rpdo_args.len = 4;
    Canopen.build_rpdo(canopen_work);
    TEST_ASSERT_FALSE(CanopenV.ok);
    ...
    CanopenV.build_tpdo_args.pdo_num = 1;
    CanopenV.build_tpdo_args.node_id = 9;
    CanopenV.build_tpdo_args.data = NULL;
    CanopenV.build_tpdo_args.len = 0;
    Canopen.build_tpdo(canopen_work);
    TEST_ASSERT_TRUE(CanopenV.ok);
...
void test_classifier_rejects_extended_and_unknown(void)
{
    ...
    CanopenV.parse_args.f = NULL;
    CanopenV.parse_args.out = &m;
    Canopen.parse(canopen_work);
    TEST_ASSERT_FALSE(CanopenV.ok);
    CanopenV.parse_args.f = &f;
    CanopenV.parse_args.out = NULL;
    Canopen.parse(canopen_work);
    TEST_ASSERT_FALSE(CanopenV.ok);
}
...
{
    CanFrame f;
    CanopenV.build_sdo_download_init_args.out = &f;
    CanopenV.build_sdo_download_init_args.node_id = 2;
    CanopenV.build_sdo_download_init_args.index = 0x1008u;
    CanopenV.build_sdo_download_init_args.sub = 0;
    CanopenV.build_sdo_download_init_args.total_size = 17;
    ...
    TEST_ASSERT_EQUAL_HEX8_ARRAY(WANT, f.data, 8);
    CanopenV.build_sdo_download_init_args.out = &f;
    CanopenV.build_sdo_download_init_args.node_id = 0;
    CanopenV.build_sdo_download_init_args.index = 0x1008u;
    CanopenV.build_sdo_download_init_args.sub = 0;
    CanopenV.build_sdo_download_init_args.total_size = 17;
    Canopen.build_sdo_download_init(canopen_work);
...
void test_segment_command_octet_layout(void)
{
    ...
    CanopenV.build_sdo_download_segment_args.out = &f;
    CanopenV.build_sdo_download_segment_args.node_id = 2;
    CanopenV.build_sdo_download_segment_args.toggle = PROTO_FALSE;
    CanopenV.build_sdo_download_segment_args.data = SEVEN;
    CanopenV.build_sdo_download_segment_args.len = 7;
    CanopenV.build_sdo_download_segment_args.last = PROTO_FALSE;
    ...
    CanopenV.build_sdo_download_segment_args.out = &f;
    CanopenV.build_sdo_download_segment_args.node_id = 2;
    CanopenV.build_sdo_download_segment_args.toggle = PROTO_TRUE;
    CanopenV.build_sdo_download_segment_args.data = SEVEN;
    CanopenV.build_sdo_download_segment_args.len = 7;
    CanopenV.build_sdo_download_segment_args.last = PROTO_FALSE;
    Canopen.build_sdo_download_segment(canopen_work);
    ...
    CanopenV.build_sdo_download_segment_args.toggle = PROTO_FALSE;
    CanopenV.build_sdo_download_segment_args.data = SEVEN;
    CanopenV.build_sdo_download_segment_args.len = 3;
    CanopenV.build_sdo_download_segment_args.last = PROTO_TRUE;
    Canopen.build_sdo_download_segment(canopen_work);
    TEST_ASSERT_TRUE(CanopenV.ok);
    ...
    CanopenV.parse_sdo_segment_args.f = &f;
    CanopenV.parse_sdo_segment_args.toggle = &toggle;
    CanopenV.parse_sdo_segment_args.data = data;
    CanopenV.parse_sdo_segment_args.len = &len;
    CanopenV.parse_sdo_segment_args.last = &last;
    ...
    CanopenV.build_sdo_upload_segment_req_args.out = &f;
    CanopenV.build_sdo_upload_segment_req_args.node_id = 2;
    CanopenV.build_sdo_upload_segment_req_args.toggle = PROTO_TRUE;
    ...
    CanopenV.build_sdo_upload_segment_req_args.out = &f;
    CanopenV.build_sdo_upload_segment_req_args.node_id = 2;
    CanopenV.build_sdo_upload_segment_req_args.toggle = PROTO_FALSE;
    Canopen.build_sdo_upload_segment_req(canopen_work);
    TEST_ASSERT_TRUE(CanopenV.ok);
    ...
    CanopenV.build_sdo_download_segment_args.toggle = PROTO_FALSE;
    CanopenV.build_sdo_download_segment_args.data = SEVEN;
    CanopenV.build_sdo_download_segment_args.len = 0;
    CanopenV.build_sdo_download_segment_args.last = PROTO_FALSE;
    Canopen.build_sdo_download_segment(canopen_work);
    TEST_ASSERT_FALSE(CanopenV.ok);
    CanopenV.build_sdo_download_segment_args.out = &f;
    ...
    CanopenV.build_sdo_download_segment_args.toggle = PROTO_FALSE;
    CanopenV.build_sdo_download_segment_args.data = SEVEN;
    CanopenV.build_sdo_download_segment_args.len = 8;
    CanopenV.build_sdo_download_segment_args.last = PROTO_FALSE;
    Canopen.build_sdo_download_segment(canopen_work);
    TEST_ASSERT_FALSE(CanopenV.ok);
    CanopenV.build_sdo_download_segment_args.out = &f;
    CanopenV.build_sdo_download_segment_args.node_id = 2;
    CanopenV.build_sdo_download_segment_args.toggle = PROTO_FALSE;
    CanopenV.build_sdo_download_segment_args.data = NULL;
    CanopenV.build_sdo_download_segment_args.len = 4;
    CanopenV.build_sdo_download_segment_args.last = PROTO_FALSE;
    Canopen.build_sdo_download_segment(canopen_work);
    TEST_ASSERT_FALSE(CanopenV.ok);
    CanopenV.build_sdo_upload_segment_req_args.out = &f;
    CanopenV.build_sdo_upload_segment_req_args.node_id = 128;
    CanopenV.build_sdo_upload_segment_req_args.toggle = PROTO_FALSE;
    Canopen.build_sdo_upload_segment_req(canopen_work);
    TEST_ASSERT_FALSE(CanopenV.ok);
}
...
void test_segmented_upload_reassembly(void)
{
    ...
    uint8_t buf[32];
    CanopenSdoReasm r;
    CanopenV.sdo_reasm_init_args.r = &r;
    CanopenV.sdo_reasm_init_args.buf = buf;
    CanopenV.sdo_reasm_init_args.cap = sizeof(buf);
    ...
    CanopenV.sdo_reasm_feed_args.r = &r;
    CanopenV.sdo_reasm_feed_args.data = SRC;
    CanopenV.sdo_reasm_feed_args.len = 7;
    CanopenV.sdo_reasm_feed_args.toggle = PROTO_FALSE;
    CanopenV.sdo_reasm_feed_args.last = PROTO_FALSE;
    Canopen.sdo_reasm_feed(canopen_work);
    TEST_ASSERT_TRUE(CanopenV.ok);
    CanopenV.sdo_reasm_feed_args.r = &r;
    CanopenV.sdo_reasm_feed_args.data = SRC + 7;
    CanopenV.sdo_reasm_feed_args.len = 7;
    CanopenV.sdo_reasm_feed_args.toggle = PROTO_TRUE;
    CanopenV.sdo_reasm_feed_args.last = PROTO_FALSE;
    Canopen.sdo_reasm_feed(canopen_work);
    TEST_ASSERT_TRUE(CanopenV.ok);
    CanopenV.sdo_reasm_feed_args.r = &r;
    CanopenV.sdo_reasm_feed_args.data = SRC + 14;
    CanopenV.sdo_reasm_feed_args.len = 3;
    CanopenV.sdo_reasm_feed_args.toggle = PROTO_FALSE;
    CanopenV.sdo_reasm_feed_args.last = PROTO_TRUE;
    Canopen.sdo_reasm_feed(canopen_work);
    TEST_ASSERT_TRUE(CanopenV.ok);
    ...
    CanopenV.sdo_reasm_feed_args.r = &r;
    CanopenV.sdo_reasm_feed_args.data = SRC;
    CanopenV.sdo_reasm_feed_args.len = 1;
    CanopenV.sdo_reasm_feed_args.toggle = PROTO_TRUE;
    CanopenV.sdo_reasm_feed_args.last = PROTO_FALSE;
    Canopen.sdo_reasm_feed(canopen_work);
    TEST_ASSERT_FALSE(CanopenV.ok);
    ...
    uint8_t tiny[8];
    CanopenV.sdo_reasm_init_args.r = &r;
    CanopenV.sdo_reasm_init_args.buf = tiny;
    CanopenV.sdo_reasm_init_args.cap = sizeof(tiny);
    Canopen.sdo_reasm_init(canopen_work);
    CanopenV.sdo_reasm_feed_args.r = &r;
    CanopenV.sdo_reasm_feed_args.data = SRC;
    CanopenV.sdo_reasm_feed_args.len = 7;
    ...
    CanopenV.sdo_reasm_init_args.r = &r;
    CanopenV.sdo_reasm_init_args.buf = NULL;
    CanopenV.sdo_reasm_init_args.cap = 0;
    Canopen.sdo_reasm_init(canopen_work);
    CanopenV.sdo_reasm_feed_args.r = &r;
    CanopenV.sdo_reasm_feed_args.data = SRC;
    CanopenV.sdo_reasm_feed_args.len = 1;
    ...
    Canopen.sdo_reasm_feed(canopen_work);
    TEST_ASSERT_FALSE(CanopenV.ok);
    CanopenV.sdo_reasm_init_args.r = NULL;
    CanopenV.sdo_reasm_init_args.buf = buf;
    CanopenV.sdo_reasm_init_args.cap = sizeof(buf);
