...
void test_memory_area_read_octets(void)
{
    ...
    uint8_t buf[32];
    Fins.build_memory_area_read_args.buf = buf;
    Fins.build_memory_area_read_args.cap = sizeof(buf);
    Fins.build_memory_area_read_args.h = &h;
    Fins.build_memory_area_read_args.area = FINS_AREA_DM_WORD;
...
void test_memory_area_write_octets(void)
{
    ...
    FinsHeader h = master_header();
    uint8_t buf[32];
    Fins.build_memory_area_write_args.buf = buf;
    Fins.build_memory_area_write_args.cap = sizeof(buf);
    Fins.build_memory_area_write_args.h = &h;
    Fins.build_memory_area_write_args.area = FINS_AREA_DM_WORD;
    Fins.build_memory_area_write_args.address = 100;
    Fins.build_memory_area_write_args.bit = 0;
    Fins.build_memory_area_write_args.count = 2;
    Fins.build_memory_area_write_args.data = DATA;
    Fins.build_memory_area_write_args.data_len = sizeof(DATA);
...
void test_operating_mode_commands(void)
{
    ...
    Fins.build_run_args.buf = buf;
    Fins.build_run_args.cap = sizeof(buf);
    Fins.build_run_args.h = &h;
    Fins.build_run_args.mode = FINS_RUN_MODE_RUN;
    Fins.build_run(fins_work);
    TEST_ASSERT_EQUAL_size_t(15u, Fins.n);
    ...
    Fins.build_run_args.cap = sizeof(buf);
    Fins.build_run_args.h = &h;
    Fins.build_run_args.mode = FINS_RUN_MODE_MONITOR;
    Fins.build_run(fins_work);
    TEST_ASSERT_EQUAL_size_t(15u, Fins.n);
    TEST_ASSERT_EQUAL_HEX8(0x02u, buf[14]);

    Fins.build_stop_args.buf = buf;
    Fins.build_stop_args.cap = sizeof(buf);
    Fins.build_stop_args.h = &h;
    Fins.build_stop(fins_work);
    TEST_ASSERT_EQUAL_size_t(12u, Fins.n);
...
void test_header_round_trip(void)
{
    ...
    Fins.build_command_args.cap = sizeof(buf);
    ...
    FinsCommand c;
    memset(&c, 0, sizeof(c));
    Fins.parse_command_args.buf = buf;
    Fins.parse_command_args.len = n;
    Fins.parse_command_args.out = &c;
    Fins.parse_command(fins_work);
    TEST_ASSERT_TRUE(Fins.ok);
...
void test_response_end_code(void)
{
    ...
    FinsResponse r;
    memset(&r, 0, sizeof(r));
    Fins.parse_response_args.buf = OK;
    Fins.parse_response_args.len = sizeof(OK);
    Fins.parse_response_args.out = &r;
    ...
    Fins.parse_response_args.buf = err;
    Fins.parse_response_args.len = sizeof(err);
    Fins.parse_response_args.out = &r;
    Fins.parse_response(fins_work);
    TEST_ASSERT_TRUE(Fins.ok);
...
void test_parsers_refuse_short_frames(void)
{
    ...
    FinsCommand c;
    Fins.parse_command_args.buf = buf;
    Fins.parse_command_args.len = 11;
    Fins.parse_command_args.out = &c;
    Fins.parse_command(fins_work);
    TEST_ASSERT_FALSE(Fins.ok);
    Fins.parse_command_args.buf = buf;
    Fins.parse_command_args.len = 12;
    Fins.parse_command_args.out = &c;
    Fins.parse_command(fins_work);
    TEST_ASSERT_TRUE(Fins.ok);
    TEST_ASSERT_EQUAL_size_t(0u, c.params_len);
    Fins.parse_command_args.buf = NULL;
    Fins.parse_command_args.len = 12;
    Fins.parse_command_args.out = &c;
    Fins.parse_command(fins_work);
    TEST_ASSERT_FALSE(Fins.ok);
    Fins.parse_command_args.buf = buf;
    Fins.parse_command_args.len = 12;
    Fins.parse_command_args.out = NULL;
    Fins.parse_command(fins_work);
    TEST_ASSERT_FALSE(Fins.ok);

    FinsResponse r;
    Fins.parse_response_args.buf = buf;
    Fins.parse_response_args.len = 13;
    Fins.parse_response_args.out = &r;
    Fins.parse_response(fins_work);
    TEST_ASSERT_FALSE(Fins.ok);
    Fins.parse_response_args.buf = buf;
    Fins.parse_response_args.len = 14;
    Fins.parse_response_args.out = &r;
    Fins.parse_response(fins_work);
    TEST_ASSERT_TRUE(Fins.ok);
    TEST_ASSERT_EQUAL_size_t(0u, r.data_len);
    Fins.parse_response_args.buf = NULL;
    Fins.parse_response_args.len = 14;
    Fins.parse_response_args.out = &r;
    Fins.parse_response(fins_work);
    TEST_ASSERT_FALSE(Fins.ok);
    Fins.parse_response_args.buf = buf;
    Fins.parse_response_args.len = 14;
    Fins.parse_response_args.out = NULL;
    Fins.parse_response(fins_work);
    TEST_ASSERT_FALSE(Fins.ok);
}
...
void test_builders_refuse_a_short_buffer(void)
{
    ...
    Fins.build_memory_area_read_args.buf = buf;
    Fins.build_memory_area_read_args.cap = 17;
    Fins.build_memory_area_read_args.h = &h;
    Fins.build_memory_area_read_args.area = FINS_AREA_DM_WORD;
    Fins.build_memory_area_read_args.address = 100;
    Fins.build_memory_area_read_args.bit = 0;
    Fins.build_memory_area_read_args.count = 10;
    Fins.build_memory_area_read(fins_work);
    TEST_ASSERT_EQUAL_size_t(0u, Fins.n);
    Fins.build_memory_area_read_args.buf = buf;
    Fins.build_memory_area_read_args.cap = 18;
    Fins.build_memory_area_read_args.h = &h;
    Fins.build_memory_area_read_args.area = FINS_AREA_DM_WORD;
    Fins.build_memory_area_read_args.address = 100;
    Fins.build_memory_area_read_args.bit = 0;
    ...
    Fins.build_memory_area_write_args.bit = 0;
    Fins.build_memory_area_write_args.count = 2;
    Fins.build_memory_area_write_args.data = NULL;
    Fins.build_memory_area_write_args.data_len = 4;
    Fins.build_memory_area_write(fins_work);
    TEST_ASSERT_EQUAL_size_t(0u, Fins.n);

    Fins.build_stop_args.buf = buf;
    Fins.build_stop_args.cap = 11;
    Fins.build_stop_args.h = &h;
    Fins.build_stop(fins_work);
    TEST_ASSERT_EQUAL_size_t(0u, Fins.n);
    Fins.build_run_args.buf = buf;
    Fins.build_run_args.cap = 14;
    Fins.build_run_args.h = &h;
    Fins.build_run_args.mode = FINS_RUN_MODE_RUN;
    Fins.build_run(fins_work);
    TEST_ASSERT_EQUAL_size_t(0u, Fins.n);
    Fins.build_command_args.buf = NULL;
    Fins.build_command_args.cap = sizeof(buf);
    Fins.build_command_args.h = &h;
    Fins.build_command_args.mrc = 1;
    Fins.build_command_args.src = 1;
    ...
    Fins.build_command_args.buf = buf;
    Fins.build_command_args.cap = sizeof(buf);
    Fins.build_command_args.h = NULL;
    Fins.build_command_args.mrc = 1;
    Fins.build_command_args.src = 1;
    Fins.build_command_args.params = NULL;
    Fins.build_command_args.params_len = 0;
    ...
    Fins.build_command_args.src = 1;
    Fins.build_command_args.params = NULL;
    Fins.build_command_args.params_len = 3;
    Fins.build_command(fins_work);
    TEST_ASSERT_EQUAL_size_t(0u, Fins.n);
}
