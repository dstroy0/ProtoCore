...
// A test substitutes a module by defining its ENTRY SYMBOLS and its Vars: the header owns the
// table as static const, so the seam is the symbol rather than a redefinition of the table.
RngVars RngV;
