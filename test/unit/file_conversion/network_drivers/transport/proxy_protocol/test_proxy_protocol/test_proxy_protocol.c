...
{
    *consumed = 0;
    ProxyProtocolV.parse_args.buf = (const uint8_t *)line;
    ProxyProtocolV.parse_args.len = strlen(line);
    ProxyProtocolV.parse_args.out = info;
    ProxyProtocolV.parse_args.consumed = consumed;
    ProxyProtocol.parse(proxy_protocol_work);
    return ProxyProtocolV.ok;
}
...
{
    char buf[64];
    ProxyProtocolV.v1_build_args.buf = buf;
    ProxyProtocolV.v1_build_args.cap = sizeof(buf);
    ProxyProtocolV.v1_build_args.src_addr = SRC;
    ProxyProtocolV.v1_build_args.dst_addr = DST;
    ProxyProtocolV.v1_build_args.src_port = 56324;
    ProxyProtocolV.v1_build_args.dst_port = 443;
    ProxyProtocol.v1_build(proxy_protocol_work);
    size_t n = ProxyProtocolV.n;
    TEST_ASSERT_EQUAL_STRING("PROXY TCP4 192.168.0.1 192.168.0.11 56324 443\r\n", buf);
    TEST_ASSERT_EQUAL_size_t(strlen(buf), n);

    ProxyInfo info;
    size_t consumed = 0;
    ProxyProtocolV.parse_args.buf = (const uint8_t *)buf;
    ProxyProtocolV.parse_args.len = n;
    ProxyProtocolV.parse_args.out = &info;
    ProxyProtocolV.parse_args.consumed = &consumed;
    ProxyProtocol.parse(proxy_protocol_work);
    TEST_ASSERT_TRUE(ProxyProtocolV.ok);
...
void test_v1_widest_tcp4_line_is_56_octets(void)
{
    ...
    ProxyProtocolV.v1_build_args.buf = buf;
    ProxyProtocolV.v1_build_args.cap = sizeof(buf);
    ProxyProtocolV.v1_build_args.src_addr = 0xFFFFFFFFu;
    ProxyProtocolV.v1_build_args.dst_addr = 0xFFFFFFFFu;
    ProxyProtocolV.v1_build_args.src_port = 65535;
    ProxyProtocolV.v1_build_args.dst_port = 65535;
    ProxyProtocol.v1_build(proxy_protocol_work);
    size_t n = ProxyProtocolV.n;
...
void test_v1_line_is_bounded_at_107_octets(void)
{
    ...
    line[106] = '\n';
    ProxyProtocolV.parse_args.buf = (const uint8_t *)line;
    ProxyProtocolV.parse_args.len = 107u;
    ProxyProtocolV.parse_args.out = &info;
    ProxyProtocolV.parse_args.consumed = &consumed;
    ProxyProtocol.parse(proxy_protocol_work);
    TEST_ASSERT_TRUE(ProxyProtocolV.ok);
    ...
    line[107] = '\n';
    ProxyProtocolV.parse_args.buf = (const uint8_t *)line;
    ProxyProtocolV.parse_args.len = 108u;
    ProxyProtocolV.parse_args.out = &info;
    ProxyProtocolV.parse_args.consumed = &consumed;
    ProxyProtocol.parse(proxy_protocol_work);
    TEST_ASSERT_FALSE(ProxyProtocolV.ok);
}
...
{
    uint8_t buf[32];
    ProxyProtocolV.v2_build_args.buf = buf;
    ProxyProtocolV.v2_build_args.cap = sizeof(buf);
    ProxyProtocolV.v2_build_args.src_addr = SRC;
    ProxyProtocolV.v2_build_args.dst_addr = DST;
    ProxyProtocolV.v2_build_args.src_port = 56324;
    ProxyProtocolV.v2_build_args.dst_port = 443;
...
void test_v2_round_trip(void)
{
    ...
    ProxyInfo info;
    size_t consumed = 0;
    ProxyProtocolV.parse_args.buf = buf;
    ProxyProtocolV.parse_args.len = n;
    ProxyProtocolV.parse_args.out = &info;
    ProxyProtocolV.parse_args.consumed = &consumed;
    ProxyProtocol.parse(proxy_protocol_work);
...
void test_v2_local_command_yields_no_address(void)
{
    ...
    ProxyProtocolV.parse_args.buf = hdr;
    ProxyProtocolV.parse_args.len = n;
    ProxyProtocolV.parse_args.out = &info;
    ProxyProtocolV.parse_args.consumed = &consumed;
    ProxyProtocol.parse(proxy_protocol_work);
...
void test_partial_headers_are_refused(void)
{
    ...
    ProxyProtocolV.parse_args.buf = (const uint8_t *)v1;
    ProxyProtocolV.parse_args.len = strlen(v1);
    ProxyProtocolV.parse_args.out = &info;
    ProxyProtocolV.parse_args.consumed = &consumed;
    ProxyProtocol.parse(proxy_protocol_work);
    TEST_ASSERT_FALSE(ProxyProtocolV.ok);
    ...
    {
        ProxyProtocolV.parse_args.buf = hdr;
        ProxyProtocolV.parse_args.len = len;
        ProxyProtocolV.parse_args.out = &info;
        ProxyProtocolV.parse_args.consumed = &consumed;
        ProxyProtocol.parse(proxy_protocol_work);
        TEST_ASSERT_FALSE(ProxyProtocolV.ok);
    ...
    memset(hdr + 16, 0, 12);
    ProxyProtocolV.parse_args.buf = hdr;
    ProxyProtocolV.parse_args.len = 28u;
    ProxyProtocolV.parse_args.out = &info;
    ProxyProtocolV.parse_args.consumed = &consumed;
    ProxyProtocol.parse(proxy_protocol_work);
    TEST_ASSERT_TRUE(ProxyProtocolV.ok);
...
void test_a_stream_without_a_proxy_header_is_refused(void)
{
    ...
    ProxyProtocolV.parse_args.buf = (const uint8_t *)http;
    ProxyProtocolV.parse_args.len = strlen(http);
    ProxyProtocolV.parse_args.out = &info;
    ProxyProtocolV.parse_args.consumed = &consumed;
    ProxyProtocol.parse(proxy_protocol_work);
    TEST_ASSERT_FALSE(ProxyProtocolV.ok);
    ...
    ProxyProtocolV.parse_args.buf = tiny;
    ProxyProtocolV.parse_args.len = sizeof(tiny);
    ProxyProtocolV.parse_args.out = &info;
    ProxyProtocolV.parse_args.consumed = &consumed;
    ProxyProtocol.parse(proxy_protocol_work);
    TEST_ASSERT_FALSE(ProxyProtocolV.ok);
...
{
    char small[16];
    ProxyProtocolV.v1_build_args.buf = small;
    ProxyProtocolV.v1_build_args.cap = sizeof(small);
    ProxyProtocolV.v1_build_args.src_addr = SRC;
    ProxyProtocolV.v1_build_args.dst_addr = DST;
    ProxyProtocolV.v1_build_args.src_port = 56324;
    ProxyProtocolV.v1_build_args.dst_port = 443;
    ProxyProtocol.v1_build(proxy_protocol_work);
    TEST_ASSERT_EQUAL_size_t(0u, ProxyProtocolV.n);
    uint8_t v2small[27];
    ProxyProtocolV.v2_build_args.buf = v2small;
    ProxyProtocolV.v2_build_args.cap = sizeof(v2small);
    ProxyProtocolV.v2_build_args.src_addr = SRC;
    ProxyProtocolV.v2_build_args.dst_addr = DST;
    ProxyProtocolV.v2_build_args.src_port = 56324;
    ProxyProtocolV.v2_build_args.dst_port = 443;
...
void test_null_arguments_are_refused(void)
{
    ...
    size_t consumed = 0;
    uint8_t any[16] = {0};
    ProxyProtocolV.parse_args.buf = NULL;
    ProxyProtocolV.parse_args.len = sizeof(any);
    ProxyProtocolV.parse_args.out = &info;
    ProxyProtocolV.parse_args.consumed = &consumed;
    ProxyProtocol.parse(proxy_protocol_work);
    TEST_ASSERT_FALSE(ProxyProtocolV.ok);
    ProxyProtocolV.parse_args.buf = any;
    ProxyProtocolV.parse_args.len = sizeof(any);
    ProxyProtocolV.parse_args.out = NULL;
    ProxyProtocolV.parse_args.consumed = &consumed;
    ProxyProtocol.parse(proxy_protocol_work);
    TEST_ASSERT_FALSE(ProxyProtocolV.ok);
    ProxyProtocolV.parse_args.buf = any;
    ProxyProtocolV.parse_args.len = sizeof(any);
    ProxyProtocolV.parse_args.out = &info;
    ProxyProtocolV.parse_args.consumed = NULL;
    ProxyProtocol.parse(proxy_protocol_work);
    TEST_ASSERT_FALSE(ProxyProtocolV.ok);
    ProxyProtocolV.v1_build_args.buf = NULL;
    ProxyProtocolV.v1_build_args.cap = 64;
    ProxyProtocolV.v1_build_args.src_addr = SRC;
    ProxyProtocolV.v1_build_args.dst_addr = DST;
    ProxyProtocolV.v1_build_args.src_port = 1;
    ProxyProtocolV.v1_build_args.dst_port = 2;
    ProxyProtocol.v1_build(proxy_protocol_work);
    TEST_ASSERT_EQUAL_size_t(0u, ProxyProtocolV.n);
    ProxyProtocolV.v2_build_args.buf = NULL;
    ProxyProtocolV.v2_build_args.cap = 64;
    ProxyProtocolV.v2_build_args.src_addr = SRC;
    ProxyProtocolV.v2_build_args.dst_addr = DST;
    ProxyProtocolV.v2_build_args.src_port = 1;
    ProxyProtocolV.v2_build_args.dst_port = 2;
    ProxyProtocol.v2_build(proxy_protocol_work);
    TEST_ASSERT_EQUAL_size_t(0u, ProxyProtocolV.n);
}
