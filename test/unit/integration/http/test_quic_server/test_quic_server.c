                        ...
                        const uint8_t *, size_t)
{
    ...
    QuicServerV.stream.stream_id = sid;
    QuicServerV.resp.status = 200;
    QuicServerV.resp.content_type = "text/plain";
    QuicServerV.resp.body = (const uint8_t *)"hello h3";
    QuicServerV.resp.body_len = 8;
...
void test_quic_server_http3_get()
{
    ...
    QuicServerV.begin_args.port = H3_PORT;
    QuicServerV.begin_args.cfg = &scfg;
    QuicServerV.begin_args.on_request = app_request;
    QuicServerV.begin_args.app = NULL;
    QuicServer.begin(protocore_quic_server_span());
    TEST_ASSERT_TRUE(QuicServerV.ok);
    ...
    TEST_ASSERT_EQUAL_UINT8(1, QuicServerV.u8);
    ...
    QuicServer.active_conns(protocore_quic_server_span());
    TEST_ASSERT_EQUAL_UINT8(0, QuicServerV.u8);
}
...
void test_quic_server_input_guards()
{
    ...
    QuicServerV.begin_args.port = H3_PORT;
    QuicServerV.begin_args.cfg = NULL;
    QuicServerV.begin_args.on_request = app_request;
    QuicServerV.begin_args.app = NULL;
    QuicServer.begin(protocore_quic_server_span());
    TEST_ASSERT_FALSE(QuicServerV.ok);
    QuicServerConfig scfg;
    config(&scfg, NULL);
    QuicServerV.begin_args.port = H3_PORT;
    QuicServerV.begin_args.cfg = &scfg;
    ...
    QuicServerV.stream.conn_id = 999999;
    QuicServerV.stream.stream_id = 0;
    QuicServerV.resp.status = 200;
    QuicServerV.resp.content_type = "text/plain";
    QuicServerV.resp.body = NULL;
    QuicServerV.resp.body_len = 0;
    QuicServer.respond(protocore_quic_server_span());
    TEST_ASSERT_FALSE(QuicServerV.ok);
...
void test_ingest_ring_drops_past_capacity()
{
    ...
    run(0);
    QuicServer.active_conns(protocore_quic_server_span());
    TEST_ASSERT_EQUAL_UINT8(2, QuicServerV.u8);
...
void test_quic_server_pool_full()
{
    ...
    run(0);
    QuicServer.active_conns(protocore_quic_server_span());
    TEST_ASSERT_EQUAL_UINT8(PROTOCORE_QUIC_MAX_CONNS, QuicServerV.u8);
    QuicServer.stop(protocore_quic_server_span());
}
...
void test_quic_server_on_request_null()
{
    ...
    QuicServerV.begin_args.port = H3_PORT;
    QuicServerV.begin_args.cfg = &scfg;
    QuicServerV.begin_args.on_request = NULL;
    QuicServerV.begin_args.app = NULL;
    QuicServer.begin(protocore_quic_server_span());
    TEST_ASSERT_TRUE(QuicServerV.ok);
