...
{
    uint8_t adu[16];
    TEST_ASSERT_EQUAL_size_t(0, protocore_modbus_build_read(0x06, 1, 1, 0, 2, adu, sizeof(adu)));
    TEST_ASSERT_EQUAL_size_t(0, protocore_modbus_build_read(0x03, 1, 1, 0, 0, adu, sizeof(adu)));
    TEST_ASSERT_EQUAL_size_t(0, protocore_modbus_build_read(0x03, 1, 1, 0, 200, adu, sizeof(adu)));
    TEST_ASSERT_EQUAL_size_t(0, protocore_modbus_build_read(0x03, 1, 1, 0, 2, adu, 4));
}
...
{
    uint8_t adu[16];
    TEST_ASSERT_EQUAL_size_t(0, protocore_modbus_build_read(0x03, 1, 1, 0, 2, NULL, 16));
    size_t n = protocore_modbus_build_read(0x04, 1, 1, 0, 2, adu, sizeof(adu));
    TEST_ASSERT_EQUAL_size_t(12, n);
...
void test_parse_max_regs_and_null_out()
{
    ...
    uint16_t regs[2];
    int got = protocore_modbus_parse_response(adu, sizeof(adu), regs, 2, &ex);
    TEST_ASSERT_EQUAL_INT(2, got);
...
void test_round_trip_write_single()
{
    ...
    TEST_ASSERT_EQUAL_HEX16(0x5A5A, protocore_modbus_get_holding_reg(7));
}
...
void test_build_write_rejects_bad_args()
{
    ...
    TEST_ASSERT_EQUAL_size_t(0, protocore_modbus_build_write_single(1, 1, 0, 5, NULL, 16));
    TEST_ASSERT_EQUAL_size_t(0, protocore_modbus_build_write_single(1, 1, 0, 5, adu, 4));
    TEST_ASSERT_EQUAL_size_t(0, protocore_modbus_build_write_multiple(1, 1, 0, vals, 2, NULL, 32));
    TEST_ASSERT_EQUAL_size_t(0, protocore_modbus_build_write_multiple(1, 1, 0, NULL, 2, adu, 32));
    TEST_ASSERT_EQUAL_size_t(0, protocore_modbus_build_write_multiple(1, 1, 0, vals, 0, adu, 32));
    TEST_ASSERT_EQUAL_size_t(0, protocore_modbus_build_write_multiple(1, 1, 0, vals, 124, adu, 300));
    TEST_ASSERT_EQUAL_size_t(0, protocore_modbus_build_write_multiple(1, 1, 0, vals, 2, adu, 16));
}
...
void test_parse_write_response_edges()
{
    ...
    TEST_ASSERT_EQUAL_INT(-1, protocore_modbus_parse_write_response(NULL, 12, &addr, &ex));
}
...
void test_round_trip_read_coils()
{
    ...
    protocore_modbus_set_coil(9, PROTO_TRUE);
...
void test_round_trip_write_single_coil()
{
    ...
    TEST_ASSERT_TRUE(protocore_modbus_get_coil(5));
}
...
void test_round_trip_mask_write()
{
    ...
    TEST_ASSERT_EQUAL_HEX16(0x1534, protocore_modbus_get_holding_reg(10));
}
...
void test_round_trip_read_write_multiple()
{
    ...
    TEST_ASSERT_EQUAL_HEX16(0xBBBB, protocore_modbus_get_holding_reg(21));
}
