...
[![Version](https://img.shields.io/badge/version-v1.0.16-blue)](docs/CHANGELOG.md)
...
| | |
| --- | --- |
| Host test suite | **4,992 tests** pass across 440 native environments |
| Measured coverage | **69.8% line**, **63.8% branch** over 355 instrumented files |
...
- **Supported today**: ESP32 - 13 variant profiles (classic, S2, S3, S31, C2, C3, C5, C6, C61,
  ...
  [`vendor/board_profiles/esp/`](vendor/board_profiles/esp/).
