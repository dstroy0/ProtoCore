...
#define PROTOCORE_SHA_CLK_REG 0x600960CCu // PCR_SHA_CONF_REG
#endif
#ifndef PROTOCORE_SHA_CLK_BIT
#define PROTOCORE_SHA_CLK_BIT (1u << 0) // PCR_SHA_CLK_EN
#endif
#ifndef PROTOCORE_SHA_RST_REG
#define PROTOCORE_SHA_RST_REG 0x600960CCu // PCR_SHA_CONF_REG (same reg)
#endif
