 ...
 * differ. The classic ESP32 has no single-shot MODMULT, so it (and native builds) leave PROTOCORE_RSA_MODMUL_HW
 ...
 * by @ref protocore_rsa_hw_acquire and dropped by @ref protocore_rsa_hw_release; a scalar-mult holds it across its
 * whole run of multiplies.
 */
...
#define PROTOCORE_RSA_MODMUL_HW 1
#endif
...
#define PROTOCORE_RSA_BASE 0x6003C000u
#define PROTOCORE_RSA_CLK_REG 0x600C001Cu  // SYSTEM_PERIP_CLK_EN1_REG
#define PROTOCORE_RSA_CLK_BIT (1u << 3)    // SYSTEM_CRYPTO_RSA_CLK_EN
#define PROTOCORE_RSA_RST_REG 0x600C0024u  // SYSTEM_PERIP_RST_EN1_REG
#define PROTOCORE_RSA_RST_BIT (1u << 3)    // SYSTEM_CRYPTO_RSA_RST
#define PROTOCORE_RSA_HOLD_REG 0x600C0024u // SYSTEM_PERIP_RST_EN1_REG (same reg)
#define PROTOCORE_RSA_HOLD_CLEAR (1u << 4) // SYSTEM_CRYPTO_DS_RST
#define PROTOCORE_RSA_HAS_PD 1
#define PROTOCORE_RSA_PD_REG 0x600C0040u                              // SYSTEM_RSA_PD_CTRL_REG
#define PROTOCORE_RSA_PD_UP_CLEAR (1u << 0)                           // clear SYSTEM_RSA_MEM_PD to power up
#define PROTOCORE_RSA_PD_DOWN_BIT (1u << 0)                           // SYSTEM_RSA_MEM_PD reads 1 when powered down
#elif defined(CONFIG_IDF_TARGET_ESP32S2) && CONFIG_IDF_TARGET_ESP32S2 // hw_ver1, DPORT clock/reset
#define PROTOCORE_RSA_BASE 0x6003C000u
#define PROTOCORE_RSA_CLK_REG 0x3F4C0044u  // DPORT_PERIP_CLK_EN1_REG
#define PROTOCORE_RSA_CLK_BIT (1u << 3)    // DPORT_CRYPTO_RSA_CLK_EN
#define PROTOCORE_RSA_RST_REG 0x3F4C004Cu  // DPORT_PERIP_RST_EN1_REG
#define PROTOCORE_RSA_RST_BIT (1u << 3)    // DPORT_CRYPTO_RSA_RST
#define PROTOCORE_RSA_HOLD_REG 0x3F4C004Cu // DPORT_PERIP_RST_EN1_REG (same reg)
#define PROTOCORE_RSA_HOLD_CLEAR (1u << 4) // DPORT_CRYPTO_DS_RST
#define PROTOCORE_RSA_HAS_PD 1
#define PROTOCORE_RSA_PD_REG 0x3F4C0068u                              // DPORT_RSA_PD_CTRL_REG
#define PROTOCORE_RSA_PD_UP_CLEAR (1u << 0)                           // clear DPORT_RSA_MEM_PD to power up
#define PROTOCORE_RSA_PD_DOWN_BIT (1u << 0)                           // DPORT_RSA_MEM_PD reads 1 when powered down
#elif defined(CONFIG_IDF_TARGET_ESP32C3) && CONFIG_IDF_TARGET_ESP32C3 // hw_ver1, SYSTEM clock/reset
#define PROTOCORE_RSA_BASE 0x6003C000u
#define PROTOCORE_RSA_CLK_REG 0x600C0014u  // SYSTEM_PERIP_CLK_EN1_REG
#define PROTOCORE_RSA_CLK_BIT (1u << 3)    // SYSTEM_CRYPTO_RSA_CLK_EN
#define PROTOCORE_RSA_RST_REG 0x600C001Cu  // SYSTEM_PERIP_RST_EN1_REG
#define PROTOCORE_RSA_RST_BIT (1u << 3)    // SYSTEM_CRYPTO_RSA_RST
#define PROTOCORE_RSA_HOLD_REG 0x600C001Cu // SYSTEM_PERIP_RST_EN1_REG (same reg)
#define PROTOCORE_RSA_HOLD_CLEAR (1u << 4) // SYSTEM_CRYPTO_DS_RST
#define PROTOCORE_RSA_HAS_PD 1
#define PROTOCORE_RSA_PD_REG 0x600C0038u                              // SYSTEM_RSA_PD_CTRL_REG
#define PROTOCORE_RSA_PD_UP_CLEAR (1u << 0)                           // clear SYSTEM_RSA_MEM_PD to power up
#define PROTOCORE_RSA_PD_DOWN_BIT (1u << 0)                           // SYSTEM_RSA_MEM_PD reads 1 when powered down
#elif defined(CONFIG_IDF_TARGET_ESP32P4) && CONFIG_IDF_TARGET_ESP32P4 // hw_ver3, HP_SYS_CLKRST clock/reset
#define PROTOCORE_RSA_BASE 0x50092000u
#define PROTOCORE_RSA_CLK_REG 0x500E60A8u                               // HP_SYS_CLKRST_PERI_CLK_CTRL25_REG
#define PROTOCORE_RSA_CLK_BIT (1u << 18)                                // REG_CRYPTO_RSA_CLK_EN
#define PROTOCORE_RSA_RST_REG 0x500E60C8u                               // HP_SYS_CLKRST_HP_RST_EN2_REG
#define PROTOCORE_RSA_RST_BIT (1u << 21)                                // REG_RST_EN_RSA
#define PROTOCORE_RSA_HOLD_REG 0x500E60C8u                              // HP_SYS_CLKRST_HP_RST_EN2_REG (same reg)
#define PROTOCORE_RSA_HOLD_CLEAR ((1u << 14) | (1u << 17) | (1u << 20)) // parent-crypto | DS | ECDSA
#define PROTOCORE_RSA_HAS_PD 0                                          // P4 RSA memory is always powered
#elif defined(CONFIG_IDF_TARGET_ESP32C6) && CONFIG_IDF_TARGET_ESP32C6   // hw_ver3 regs, PCR clock/reset
#define PROTOCORE_RSA_BASE 0x6008A000u
#define PROTOCORE_RSA_CLK_REG 0x600960D0u  // PCR_RSA_CONF_REG
#define PROTOCORE_RSA_CLK_BIT (1u << 0)    // PCR_RSA_CLK_EN
#define PROTOCORE_RSA_RST_REG 0x600960D0u  // PCR_RSA_CONF_REG (same reg)
#define PROTOCORE_RSA_RST_BIT (1u << 1)    // PCR_RSA_RST_EN
#define PROTOCORE_RSA_HOLD_REG 0x600960E0u // PCR_DS_CONF_REG (a DIFFERENT register)
#define PROTOCORE_RSA_HOLD_CLEAR (1u << 1) // PCR_DS_RST_EN
#define PROTOCORE_RSA_HAS_PD 1
#define PROTOCORE_RSA_PD_REG 0x600960D4u                  // PCR_RSA_PD_CTRL_REG
#define PROTOCORE_RSA_PD_UP_CLEAR ((1u << 0) | (1u << 2)) // clear PCR_RSA_MEM_PD + PCR_RSA_MEM_FORCE_PD to power up
#define PROTOCORE_RSA_PD_DOWN_BIT (1u << 0)               // PCR_RSA_MEM_PD reads 1 when powered down
#elif defined(CONFIG_IDF_TARGET_ESP32C5) && CONFIG_IDF_TARGET_ESP32C5 // hw_ver3 regs, PCR (DS + ECDSA resets)
#define PROTOCORE_RSA_BASE 0x6008A000u
#define PROTOCORE_RSA_CLK_REG 0x600960D4u   // PCR_RSA_CONF_REG
#define PROTOCORE_RSA_CLK_BIT (1u << 0)     // PCR_RSA_CLK_EN
#define PROTOCORE_RSA_RST_REG 0x600960D4u   // PCR_RSA_CONF_REG (same reg)
#define PROTOCORE_RSA_RST_BIT (1u << 1)     // PCR_RSA_RST_EN
#define PROTOCORE_RSA_HOLD_REG 0x600960E4u  // PCR_DS_CONF_REG
#define PROTOCORE_RSA_HOLD_CLEAR (1u << 1)  // PCR_DS_RST_EN
#define PROTOCORE_RSA_HOLD2_REG 0x600960ECu // PCR_ECDSA_CONF_REG (a second, separate register)
#define PROTOCORE_RSA_HOLD2_CLEAR (1u << 1) // PCR_ECDSA_RST_EN
#define PROTOCORE_RSA_HAS_PD 1
#define PROTOCORE_RSA_PD_REG 0x600960D8u                  // PCR_RSA_PD_CTRL_REG
#define PROTOCORE_RSA_PD_UP_CLEAR ((1u << 0) | (1u << 2)) // clear PCR_RSA_MEM_PD + PCR_RSA_MEM_FORCE_PD to power up
#define PROTOCORE_RSA_PD_DOWN_BIT (1u << 0)               // PCR_RSA_MEM_PD reads 1 when powered down
#elif defined(CONFIG_IDF_TARGET_ESP32H2) && CONFIG_IDF_TARGET_ESP32H2 // hw_ver3 regs, PCR (DS + ECDSA resets)
#define PROTOCORE_RSA_BASE 0x6008A000u
#define PROTOCORE_RSA_CLK_REG 0x600960CCu   // PCR_RSA_CONF_REG
#define PROTOCORE_RSA_CLK_BIT (1u << 0)     // PCR_RSA_CLK_EN
#define PROTOCORE_RSA_RST_REG 0x600960CCu   // PCR_RSA_CONF_REG (same reg)
#define PROTOCORE_RSA_RST_BIT (1u << 1)     // PCR_RSA_RST_EN
#define PROTOCORE_RSA_HOLD_REG 0x600960DCu  // PCR_DS_CONF_REG
#define PROTOCORE_RSA_HOLD_CLEAR (1u << 1)  // PCR_DS_RST_EN
#define PROTOCORE_RSA_HOLD2_REG 0x600960E4u // PCR_ECDSA_CONF_REG (a second, separate register)
#define PROTOCORE_RSA_HOLD2_CLEAR (1u << 1) // PCR_ECDSA_RST_EN
#define PROTOCORE_RSA_HAS_PD 1
#define PROTOCORE_RSA_PD_REG 0x600960D0u                  // PCR_RSA_PD_CTRL_REG
#define PROTOCORE_RSA_PD_UP_CLEAR ((1u << 0) | (1u << 2)) // clear PCR_RSA_MEM_PD + PCR_RSA_MEM_FORCE_PD to power up
#define PROTOCORE_RSA_PD_DOWN_BIT (1u << 0)               // PCR_RSA_MEM_PD reads 1 when powered down
#else
#error "esp_crypto_hal: PROTOCORE_RSA_MODMUL_HW is on but no RSA register map for this die - add its bases/bits"
#endif

// ── RSA block register offsets (identical across hw_ver1 and hw_ver3) ────────────────────────────────────
#define PROTOCORE_RSA_MEM_M (PROTOCORE_RSA_BASE + 0x000u)  // operand M block (words)
#define PROTOCORE_RSA_MEM_Z (PROTOCORE_RSA_BASE + 0x200u)  // result Z block (also seeded with R^2 mod m)
#define PROTOCORE_RSA_MEM_Y (PROTOCORE_RSA_BASE + 0x400u)  // operand Y block
#define PROTOCORE_RSA_MEM_X (PROTOCORE_RSA_BASE + 0x600u)  // operand X block
#define PROTOCORE_RSA_MPRIME (PROTOCORE_RSA_BASE + 0x800u) // Montgomery m' (mod 2^32)
#define PROTOCORE_RSA_MODE (PROTOCORE_RSA_BASE + 0x804u)   // operand length in words, minus 1
#define PROTOCORE_RSA_CLEAN                                                                                            \
    (PROTOCORE_RSA_BASE + 0x808u) // memory-init: reads non-zero while initializing, 0 when ready
#define PROTOCORE_RSA_START (PROTOCORE_RSA_BASE + 0x810u)  // write 1 to start the modular multiply
#define PROTOCORE_RSA_DONE (PROTOCORE_RSA_BASE + 0x818u)   // reads 1 once the op is complete (interrupt/idle bit)
#define PROTOCORE_RSA_INTCLR (PROTOCORE_RSA_BASE + 0x81Cu) // write 1 to clear the completion flag
#define PROTOCORE_RSA_INTENA (PROTOCORE_RSA_BASE + 0x82Cu) // completion-interrupt enable (we poll: keep 0)

/** @brief Iterations a hardware status poll takes before it gives up and the modmul zeroes its result. */
#ifndef PROTOCORE_RSA_SPIN_MAX
#define PROTOCORE_RSA_SPIN_MAX 100000u
#endif

/**
 * @brief Acquire the RSA accelerator for a run of modular multiplies (PC lock + direct-register bring-up).
 * @note  Bracket every batch of @ref protocore_rsa_modmul with acquire/release. Implemented in esp_crypto_hal.cpp
...
/**
 * @brief `z = x*y mod m` (@p words limbs) on the RSA accelerator. Requires @ref protocore_rsa_hw_acquire first.
