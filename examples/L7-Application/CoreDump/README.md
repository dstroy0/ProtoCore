...
pio ci --board=esp32dev --project-option="framework=arduino" \
  --project-option="build_flags=-DPROTOCORE_ENABLE_EXC_DECODER=1 -DPROTOCORE_ENABLE_FTP=1 -DPROTOCORE_ENABLE_FTP_SESSION=1 -DPROTOCORE_ENABLE_TCP_CLIENT=1 -DPROTOCORE_ENABLE_DNS_RESOLVER=1 -DPROTOCORE_ENABLE_MNT=1 -DPROTOCORE_ENABLE_FILE_SERVING=1" \
