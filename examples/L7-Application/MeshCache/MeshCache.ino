...
/**
 * @file MeshCache.ino
 * @brief Share a warm edge cache across a fleet (PROTOCORE_ENABLE_EDGE_MESH).
 *
 ...
 * -DPROTOCORE_ENABLE_EDGE_MESH=1. In the Arduino IDE they are set for you in build_opt.h.
 *
 * SIZING: build_opt.h dials the cache down (PROTOCORE_EDGE_CACHE_SLOTS=2, PROTOCORE_EDGE_FETCH_SLOTS=1,
 * PROTOCORE_MESH_MAX_PEERS=1) so the sketch's static BSS fits the classic ESP32's smaller DRAM. On a PSRAM
