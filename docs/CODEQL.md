...
| `cpp/long-switch`                | `http_parser.c:187`, `src/network_drivers/presentation/ssh/connection/ssh_server.c:39`, `websocket.c:279` | **Won't fix (style)** - protocol state machines / message dispatchers; a long `switch` is the clearest form.                                                                                                                           |
