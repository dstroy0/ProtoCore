...
- protocore_config.h is the entry point, not protocore_types.h ([`df81505`](https://github.com/dstroy0/ProtoCore/commit/df8150515fb0d74c5947e0266b5152d3774f1beb))
...
- the i2c command link was shared per bus; protocore_mnt_fs published a C++ type ([`5153630`](https://github.com/dstroy0/ProtoCore/commit/515363041cb3b2dd963627715141dbe823e30f14))
...
- the portable TLS arm is a third carrier of PROTOCORE_ENABLE_TLS_RPK ([`02125b4`](https://github.com/dstroy0/ProtoCore/commit/02125b4f280c3fc47ad5e49e0dac4f577c2f2d07))
...
- h2_server suite passed protocore_h2_write_header its arguments out of order ([`a635744`](https://github.com/dstroy0/ProtoCore/commit/a63574447e0ad65a4f969159f2a41d086aa11011))
...
- native_ssh_pqc builds the SSH transport, so it has to define PROTOCORE_ENABLE_SSH ([`c7f4cc6`](https://github.com/dstroy0/ProtoCore/commit/c7f4cc66ccbfe933669f3c0e8d69e6506391b7a0))
- native_ssh_hardened builds the SSH stack, so it has to define PROTOCORE_ENABLE_SSH ([`ef6f509`](https://github.com/dstroy0/ProtoCore/commit/ef6f509e28d7dbde7fbf6fae894bb9b1181d5565))
...
- twelve PROTOCORE_LOGx sites still passed their values variadically ([`d4ec123`](https://github.com/dstroy0/ProtoCore/commit/d4ec12322022580b076f2348dcc223c327682aa8))
...
- the two PROTOCORE_key_max macros get distinct names at file scope ([`ce3b887`](https://github.com/dstroy0/ProtoCore/commit/ce3b8873b9d5f05f2765ce78078cffeb978073d0))
...
- protocore_ssh_conn_send reports a refused queue instead of claiming the bytes went ([`cd435b1`](https://github.com/dstroy0/ProtoCore/commit/cd435b1b660b08b9527573a1d160b5c4844c71ff))
...
- PROTOCORE_WORK_SSH_CONN carries the flight, and the crypto work it already borrowed ([`68645ad`](https://github.com/dstroy0/ProtoCore/commit/68645ade9b86aa9609a31efdad362e90a01e1777))
...
- the key schedule needs PROTOCORE_TLS13_KS_BORROW, not PROTOCORE_TLS13_KS_CAP ([`9b04dff`](https://github.com/dstroy0/ProtoCore/commit/9b04dffa4f04be0256d28adab0760db2a86ac01b))
...
- external-RAM placement selects on PROTOCORE_HAS_PSRAM ([`c5632da`](https://github.com/dstroy0/ProtoCore/commit/c5632dad43946360c29cc10aeda5c4f585f532c2))
...
- protocore_server_reset() drops the not-found handler, and native_swar builds no library source ([`c8e8af8`](https://github.com/dstroy0/ProtoCore/commit/c8e8af8a227a246e77bfb136f09cbb15629a50f2))
...
- drop the protocore_ct_is_zero case ([`ca2bec9`](https://github.com/dstroy0/ProtoCore/commit/ca2bec99078c8557042a8a2d6533c0c133a111dd))
...
- protocore_ct_eq had no test; every tag and MAC check goes through it ([`e465c91`](https://github.com/dstroy0/ProtoCore/commit/e465c9123e59f4ec03dd90bdb7eaab031440dfa2))
...
- PROTOCORE_TLS_SOFTWARE derives from PROTOCORE_ENABLE_TLS on host ([`8a24254`](https://github.com/dstroy0/ProtoCore/commit/8a24254e29389eec6c4be3eb440d0f1cd3dd32ce))
...
- native_h2server states PROTOCORE_HAS_VENDOR_TLS so the suite owns the TLS seam ([`963db3b`](https://github.com/dstroy0/ProtoCore/commit/963db3bc1398cbffedd690bbbbf3df833fe9a2b3))
...
- the worker-queue members gate with PROTOCORE_WORKER_COUNT, and native_client builds the join ([`f348ce3`](https://github.com/dstroy0/ProtoCore/commit/f348ce34a19b46fb22660e92f8d8ddf24e1c4dae))
...
- protocore_ip tags its family in .family, not .type ([`cf58a0c`](https://github.com/dstroy0/ProtoCore/commit/cf58a0c3437277a6841e9a4d005f72454e9ec2ff))
...
- one slot allocator - tcp's free_mask and udp's linear scan are protocore_slot_* ([`9069585`](https://github.com/dstroy0/ProtoCore/commit/90695855dc3c3e4681d6038697d071a57967045e))
...
- the four auth examples now enable PROTOCORE_ENABLE_AUTH ([`2eaec7a`](https://github.com/dstroy0/ProtoCore/commit/2eaec7a12c0ed9e7a8ae9a8a83e3a5a51fc64b28))
...
- declare protocore_ntp_http_date where it is defined, not behind PROTOCORE_ENABLE_NTP ([`ad646a1`](https://github.com/dstroy0/ProtoCore/commit/ad646a1aa3990bde3ca744708da9243492034ee5))
...
- extern C guard on aes128gcm.h, and drop the std includes protocore_types.h already owns ([`75203df`](https://github.com/dstroy0/ProtoCore/commit/75203df623ac4d049651665b55cdb2585b5f0e87))
...
- include the header declaring protocore_worker_set_self in worker.c ([`c0a548e`](https://github.com/dstroy0/ProtoCore/commit/c0a548e3b4ad6cf0619a820036850752506a63a1))
...
- fold five copies of the hex digit table onto PROTOCORE_HEX_LOWER ([`9c0726a`](https://github.com/dstroy0/ProtoCore/commit/9c0726ada37ef9c4c0d8bb162946b4e308d7feff))
...
- move stdatomic.h from protocore_types.h to ring.h ([`26ea42b`](https://github.com/dstroy0/ProtoCore/commit/26ea42b8af0977d310d393d7bb8af3595766c9c4))
...
- replace the protocore_atomic template and in-class initializers in two servers ([`fd1a387`](https://github.com/dstroy0/ProtoCore/commit/fd1a387ae52b3568a70ad041ba17da7a2cc4006b))
...
- move stdatomic into protocore_types.h ([`d7d2093`](https://github.com/dstroy0/ProtoCore/commit/d7d20933cb0772ecf9550cbd680d74b6bbecc2e2))
...
- enable PROTOCORE_ENABLE_FILE_SERVING for its own suite ([`94413d8`](https://github.com/dstroy0/ProtoCore/commit/94413d8adda9074e792f697c9d23ef42e5e52cbd))
...
- give the host a protocore_mnt_backend fixture and move file serving onto it ([`18a0c36`](https://github.com/dstroy0/ProtoCore/commit/18a0c3620c2ac0c7465fcfa238f28f4f772efc4d))
...
- enable PROTOCORE_ENABLE_AUTH for the auth suites ([`102cc67`](https://github.com/dstroy0/ProtoCore/commit/102cc67f86b910c47b3c54d97976f1c842486a52))
...
- build the last fixed-shape frames with protocore_sb, not snprintf ([`114a275`](https://github.com/dstroy0/ProtoCore/commit/114a2752802ef2fbbd228412cee88f0026bd004f))
...
- collapse the codec cursors onto protocore_span and give SSH signaling an owner ([`e2d0b4e`](https://github.com/dstroy0/ProtoCore/commit/e2d0b4e7a104053a6135ca68dc7955ed59fa9687))
