...
- an inbound accept could take the SSH slot the reverse tunnel held ([`e93a830`](https://github.com/dstroy0/ProtoCore/commit/e93a8307611222323d0fb033ce77bb194e6ffc74))
- the client built its own KEXINIT, and I_C / I_S were sized for one role ([`8dbfea8`](https://github.com/dstroy0/ProtoCore/commit/8dbfea8479ef17ecb8c3f6845e087c0f470105b2))
- the client role could not complete a key exchange ([`85329fe`](https://github.com/dstroy0/ProtoCore/commit/85329fe0e004c9b38261d15fde6090ea2b2006cf))
...
- update CHANGELOG.md [skip ci] ([`2ca9ff5`](https://github.com/dstroy0/ProtoCore/commit/2ca9ff5bf4cbb526750c3a2b663579c3245818a8))
...
- update test report + coverage [skip ci] ([`4ce1635`](https://github.com/dstroy0/ProtoCore/commit/4ce1635cd64229872b9e1d3099445c2900699d2f))
- update CHANGELOG.md [skip ci] ([`eafdd3b`](https://github.com/dstroy0/ProtoCore/commit/eafdd3ba5ef5efa91830bec44c83f8f39bbc4375))
- update CHANGELOG.md [skip ci] ([`41f8a5a`](https://github.com/dstroy0/ProtoCore/commit/41f8a5a99113d023c15f588791daebf2262adb31))
- update CHANGELOG.md [skip ci] ([`213c34e`](https://github.com/dstroy0/ProtoCore/commit/213c34e5a0cdbba4c073d2e9573ffac032866ca9))
...
- (housekeeping): pimpl phase 3, public handles, internal ctx, fix tests ([`51f77d2`](https://github.com/dstroy0/ProtoCore/commit/51f77d28000d651760462d80d1e27d5e9f6aae7e))
- Merge branch 'main' of https://github.com/dstroy0/ProtoCore ([`50a22d0`](https://github.com/dstroy0/ProtoCore/commit/50a22d0ce8423e5cb1146aa8cb1098801979903a))
- (housekeeping): pimpl phase 3, public handles, internal ctx, fix tests ([`88f18c9`](https://github.com/dstroy0/ProtoCore/commit/88f18c955c6b277fc673fd74a32944083caf2873))
...
- (housekeeping): pimpl phase 3, public handles, internal ctx ([`2ba91fb`](https://github.com/dstroy0/ProtoCore/commit/2ba91fb811286ef8241529c33125cd9ab8345eb2))
...
- (housekeeping): move dirs, renames, pimpl as I work through ([`bb4a8fd`](https://github.com/dstroy0/ProtoCore/commit/bb4a8fd36c8bbda528ee00b38473bdca3788d082))
- Merge branch 'main' of https://github.com/dstroy0/ProtoCore ([`ee164ab`](https://github.com/dstroy0/ProtoCore/commit/ee164ab82cc8bb3d4accd88df81ee5e1b174309d))
- (housekeeping): move dirs, renames, pimpl as I work through ([`4d2cd06`](https://github.com/dstroy0/ProtoCore/commit/4d2cd06ee76a3b22f7ddbd369da8ca2082e1cc13))
- Merge branch 'main' of https://github.com/dstroy0/ProtoCore ([`ff936c9`](https://github.com/dstroy0/ProtoCore/commit/ff936c94edde468fa13ec10828b4da4c8139a1e4))
- (housekeeping): move dirs, renames, pimpl as I work through ([`a362e7d`](https://github.com/dstroy0/ProtoCore/commit/a362e7d8043d35c61a55f1b4d5f67660106d55fd))
- (housekeeping): move dirs, renames, pimpl as I work through ([`f140888`](https://github.com/dstroy0/ProtoCore/commit/f140888d478a0768e120968ac4e8dd58bc396089))
- (housekeeping): move dirs, renames, pimpl as I work through ([`408fb25`](https://github.com/dstroy0/ProtoCore/commit/408fb2525c27bcb1dcb3d5289133a724ea21e7ef))
- Merge branch 'main' of https://github.com/dstroy0/ProtoCore ([`6f95945`](https://github.com/dstroy0/ProtoCore/commit/6f95945ef27f866938f510651fec0eedc0a1b56d))
- (housekeeping): move dirs, renames, pimpl as I work through ([`e4ce7b5`](https://github.com/dstroy0/ProtoCore/commit/e4ce7b5dbd2c1bc5a2a892032762adaa4fc28584))
- (housekeeping): move dirs, renames, pimpl as I work through ([`000c58e`](https://github.com/dstroy0/ProtoCore/commit/000c58ea07aa55863bf110d08fbf23cbf0db365c))
- (housekeeping): move dirs, renames, pimpl as I work through ([`61ea2e5`](https://github.com/dstroy0/ProtoCore/commit/61ea2e5f711116e4eb5648f72cc8cb8656dae0ff))
...
- docs prose bugfix ([`f332146`](https://github.com/dstroy0/ProtoCore/commit/f332146a579fea28249d2efdf10352b76a97b073))
...
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`b33d8d0`](https://github.com/dstroy0/ProtoCore/commit/b33d8d0879797d12992cc4a61f4bf0d17d9bc2c2))
- regenerate feature tables + configurator + build_opt.h + example index [skip ci] ([`ef4d95c`](https://github.com/dstroy0/ProtoCore/commit/ef4d95cb83f9efd3bbb7a556c616e6e268d29a58))
...
- src2png renders a directory tree, paged by size ([`7dcfc7e`](https://github.com/dstroy0/ProtoCore/commit/7dcfc7e6e6b4b6246ddcd67577e00b197efba11e))
...
- the host key validator moves into the KEX processor ([`afdb3c5`](https://github.com/dstroy0/ProtoCore/commit/afdb3c57afad6a6aace97c760f768e1053d23b23))
- drop the unused sec 7.2 derive wrapper, fix four .cpp comments ([`b4312f2`](https://github.com/dstroy0/ProtoCore/commit/b4312f22efd258ad17123c9ffe793ebe709981f3))
- the window adjust goes back to the signaling owner ([`8cf64eb`](https://github.com/dstroy0/ProtoCore/commit/8cf64eb6bbb9b1d8783d452417167cceca08d856))
- one owner for the exchange-hash algorithm question ([`f0b5036`](https://github.com/dstroy0/ProtoCore/commit/f0b5036d4aa90b151d51a7e0401fd07707ba2925))
- one RFC 4253 sec 8 exchange hash for both roles ([`2b46efc`](https://github.com/dstroy0/ProtoCore/commit/2b46efc24a2cd8de7f13e626943834496277b2f1))
