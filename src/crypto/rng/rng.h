...
// `Rng.fill(work)` resolves to a named function and becomes a DIRECT call. An extern table
// leaves the call indirect and the symbol live at every level, -O2 -flto included.
static const RngNs Rng __attribute__((unused)) = {
    .fill = protocore_rng_fill,
    .reseed = protocore_rng_reseed,
};
