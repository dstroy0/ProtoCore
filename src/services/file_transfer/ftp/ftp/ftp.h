...
typedef struct
{
    ...
    void (*const build_port)(uint8_t *work);
    void (*const build_eprt)(uint8_t *work);
    void (*const parse_reply)(uint8_t *work);
    void (*const parse_pasv)(uint8_t *work);
    void (*const parse_epsv)(uint8_t *work);
} FtpNs;
