...
typedef struct
{
    void (*const tpkt_build)(uint8_t *work);
    void (*const tpkt_parse)(uint8_t *work);
    void (*const build_dt)(uint8_t *work);
    void (*const build_cr)(uint8_t *work);
    void (*const build_cc)(uint8_t *work);
