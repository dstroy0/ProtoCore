...
typedef struct
{
    void (*const bvlc_build)(uint8_t *work);
    void (*const bvlc_parse)(uint8_t *work);
    void (*const npdu_build)(uint8_t *work);
    void (*const npdu_parse)(uint8_t *work);
    void (*const apdu_parse)(uint8_t *work);
    void (*const apdu_build_who_is)(uint8_t *work);
    void (*const apdu_build_i_am)(uint8_t *work);
    void (*const apdu_build_read_property)(uint8_t *work);
} BacnetNs;
