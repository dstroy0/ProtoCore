...
typedef struct
{
    void (*const accept_for_key)(uint8_t *work);
    void (*const build_opening_handshake)(uint8_t *work);
    void (*const check_server_handshake)(uint8_t *work);
    ...
    void (*const send_text)(uint8_t *work);
    void (*const send_binary)(uint8_t *work);
