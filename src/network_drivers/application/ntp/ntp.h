...
#define PC_NTP_MODE_RESERVED 0u
#define PC_NTP_MODE_SYM_ACTIVE 1u
#define PC_NTP_MODE_SYM_PASSIVE 2u
#define PC_NTP_MODE_CLIENT 3u
#define PC_NTP_MODE_SERVER 4u
#define PC_NTP_MODE_BROADCAST 5u
#define PC_NTP_MODE_CONTROL 6u
#define PC_NTP_MODE_PRIVATE 7u

// Leap indicator, RFC 5905 sec 7.3.
#define PC_NTP_LI_NONE 0u
#define PC_NTP_LI_ADD_SEC 1u
#define PC_NTP_LI_DEL_SEC 2u
...
#define PC_NTP_STRATUM_KOD 0u
#define PC_NTP_STRATUM_PRIMARY 1u
#define PC_NTP_STRATUM_MAX 15u
#define PC_NTP_STRATUM_UNSYNC 16u
