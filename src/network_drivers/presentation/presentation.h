...
void protocore_presentation_reset(uint8_t *restrict work);
void protocore_presentation_conn_open(uint8_t *restrict work);
void protocore_presentation_parse(uint8_t *restrict work);
void protocore_presentation_keepalive_eval(uint8_t *restrict work);
void protocore_presentation_has_token(uint8_t *restrict work);
void protocore_presentation_proto_handler(uint8_t *restrict work);
void protocore_presentation_set_poll(uint8_t *restrict work);
...
static const HttpConnNs HttpConn __attribute__((unused)) = {
    .reset = protocore_presentation_reset,
    .conn_open = protocore_presentation_conn_open,
    .parse = protocore_presentation_parse,
    .keepalive_eval = protocore_presentation_keepalive_eval,
    .has_token = protocore_presentation_has_token,
    .proto_handler = protocore_presentation_proto_handler,
    .set_poll = protocore_presentation_set_poll,
};
