...
typedef struct
{
    void (*const rfwd_listener_open)(uint8_t *work);
    void (*const rfwd_listener_close)(uint8_t *work);
    void (*const proto_handler)(uint8_t *work);
    void (*const rfwd_proto_handler)(uint8_t *work);
} SshServerNs;
...
static const SshServerNs SshServer __attribute__((unused)) = {
    .rfwd_listener_open = protocore_ssh_server_rfwd_listener_open,
    .rfwd_listener_close = protocore_ssh_server_rfwd_listener_close,
    .proto_handler = protocore_ssh_server_proto_handler,
    .rfwd_proto_handler = protocore_ssh_server_rfwd_proto_handler,
};
