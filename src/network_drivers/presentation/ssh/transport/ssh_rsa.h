 ...
 *
 * Reads and parses the DER blob from NVS ("ssh_host_key"/"priv_der"), leaving n and e in
 * ssh_host_pubkey and the private exponent in a secure-pool borrow. Call once at startup
 * (single-threaded).
