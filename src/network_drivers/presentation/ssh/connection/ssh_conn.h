...
#define SSH_OFF_I_S (SSH_OFF_I_C + PC_SSH_I_C_MAX)
#define SSH_OFF_KEXINIT (SSH_OFF_I_S + PC_SSH_I_S_MAX)
#define SSH_OFF_CPUB (SSH_OFF_KEXINIT + PC_SSH_KEXINIT_S_MAX)
#define SSH_OFF_SESSION_ID (SSH_OFF_CPUB + PC_SSH_CPUB_MAX)
