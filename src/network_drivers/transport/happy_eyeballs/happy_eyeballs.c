...
static_assert(HAPPY_EYEBALLS_OFF_CTX % _Alignof(HappyEyeballsCtx) == 0,
              "HAPPY_EYEBALLS_OFF_CTX is not a multiple of alignof(HappyEyeballsCtx) - HAPPY_EYEBALLS_CTX() would "
              "return a misaligned "
