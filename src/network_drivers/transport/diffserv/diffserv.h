...
static const DiffServNs DiffServ __attribute__((unused)) = {
    .set_default = protocore_diff_serv_set_default,
    .default_dscp = protocore_diff_serv_default_dscp,
    .set_udp = protocore_diff_serv_set_udp,
    .udp_dscp = protocore_diff_serv_udp_dscp,
};
