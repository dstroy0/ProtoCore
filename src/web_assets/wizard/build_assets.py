...
#            <!--#theme NAME-->   inject src/web_assets/themes/NAME.css before </head>
...
from tools.ci_tooling.check.stamp_version import copyright_line
...
def cmd_check(_):
    ...
    if stale:
        ...
        return 1
    print("generated assets are in sync with src/web_assets/input/")
    return 0
...
def cmd_migrate(args):
    """Extract const char arrays from a .c into editable src/web_assets/input/<NAME>.<ext> files."""
    with open(args.file, "r", encoding="utf-8") as f:
        src = f.read()
...
def main():
    p = argparse.ArgumentParser(description="Generate embedded web assets from src/web_assets/input/.")
    ...
    mp = sub.add_parser("migrate", help="extract const char arrays from a .cpp into src/web_assets/input/")
