...
"""Generate the theme library: one CSS per palette in src/web_assets/themes/generated/.
...
lets the set grow to hundreds. The seven original hand-authored themes in src/web_assets/themes/*.css are
left untouched (they carry bespoke personality - CRT scanlines, nyan trails); this only fills
src/web_assets/themes/generated/.
...
professionals a boardroom-safe default.
    ...
    python -m src.web_assets.wizard.gen_themes           # (re)generate src/web_assets/themes/generated/*.css
    python -m src.web_assets.wizard.gen_themes --check    # CI: fail if any generated theme is stale
    python -m src.web_assets.wizard.gen_themes --list      # print "name category mode" for every theme
"""
...
TEMPLATE = """/* {name} ({category}, {mode}) - generated by src/web_assets/wizard/gen_themes.py from a palette.
...
def cmd_gallery():
    ...
    lines = [
        "# Themes",
        "",
        "> Gallery generated by `src/web_assets/wizard/gen_themes.py gallery`; previews by"
        ...
        " [src/web_assets/README.md](../src/web_assets/README.md)). Need an exact color that is not here? Generate your"
