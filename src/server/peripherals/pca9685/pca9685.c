...
#error                                                                                                                 \
    "ProtoCore: PROTOCORE_ENABLE_PCA9685 needs a bus master (an I2C master). Provide one in test/core_setup/hal/<vendor>, or\
...
static_assert(PCA9685_OFF_CTX % _Alignof(Pca9685Ctx) == 0,
              "PCA9685_OFF_CTX is not a multiple of alignof(Pca9685Ctx) - PCA9685_CTX() would return a misaligned "
