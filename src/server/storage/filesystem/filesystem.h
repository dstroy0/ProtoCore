...
typedef struct
{
    ...
    void (*const status)(uint8_t *work);
    ...
    void (*const seek)(uint8_t *work);
    void (*const size)(uint8_t *work);
    void (*const exists)(uint8_t *work);
    void (*const stat)(uint8_t *work);
    void (*const remove)(uint8_t *work);
    void (*const rename)(uint8_t *work);
    void (*const copy)(uint8_t *work);
    void (*const mkdir)(uint8_t *work);
    void (*const rmdir)(uint8_t *work);
    void (*const opendir)(uint8_t *work);
    void (*const readdir)(uint8_t *work);
    void (*const read_file)(uint8_t *work);
    void (*const write_file)(uint8_t *work);
} FilesystemNs;
