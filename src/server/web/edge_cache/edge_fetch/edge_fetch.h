...
// PROTOCORE_EDGE_FETCHER_BORROW - the bytes this module runs out of - is stated in protocore_config.h, which sums
...
/**
 * @brief Open the origin connection and park request; begin the fetch. Sets .
...
PROTOCORE_NS EdgeFetchNs EdgeFetcher PROTOCORE_UNUSED = {.begin = protocore_edge_fetcher_begin,
                                                         .pump = protocore_edge_fetcher_pump,
                                                         .end = protocore_edge_fetcher_end,
                                                         .edge_resp_complete =
                                                             protocore_edge_fetcher_edge_resp_complete};
