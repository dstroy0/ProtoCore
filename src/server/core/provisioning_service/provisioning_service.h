...
static const ProvNs Prov __attribute__((unused)) = {
    .form_field = protocore_provisioning_service_form_field,
    .load = protocore_provisioning_service_load,
    .begin = protocore_provisioning_service_begin,
    .clear = protocore_provisioning_service_clear,
};
