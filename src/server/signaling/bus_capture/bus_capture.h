 ...
 *
 * @c work is PROTOCORE_BUS_CAPTURE_BORROW bytes the CALLER took, at an address it knows. It is not held past the call,
...
typedef struct
{
    void (*const can_to_socketcan)(uint8_t *work);
