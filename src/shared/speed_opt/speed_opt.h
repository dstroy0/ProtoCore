 ...
 * turn a branchless mask-select into a data-dependent branch; the OPT each crypto module states in its CMakeLists is
 * the crypto policy layer with per-die levels and those caveats.
 *
